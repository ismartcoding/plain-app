...
private suspend fun DefaultWebSocketSession.handleServerSession(
    ...
    try {
        WEBSOCKETS_LOGGER.trace("Starting websocket session for ${call.request.uri}")
...
private class WebSocketProtocolsSelector(
    ...
    override suspend fun evaluate(context: RoutingResolveContext, segmentIndex: Int): RouteSelectorEvaluation {
        ...
        if (protocols == null) {
            WEBSOCKETS_LOGGER.trace("Skipping WebSocket plugin because no Sec-WebSocket-Protocol header provided.")
