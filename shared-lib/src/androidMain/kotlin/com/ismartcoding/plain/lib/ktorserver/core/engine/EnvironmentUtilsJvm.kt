...
internal fun ApplicationEngine.Configuration.configureSSLConnectors(
    host: String,
    sslPort: String,
...
internal fun ApplicationEnvironmentBuilder.configurePlatformProperties(args: Array<String>) {
...
internal fun getKtorEnvironmentProperties(): List<Pair<String, String>> = buildList {
...
internal fun getEnvironmentProperty(key: String): String? {
    return System.getProperty(key)
}

internal fun setEnvironmentProperty(key: String, value: String) {
    System.setProperty(key, value)
}

internal fun clearEnvironmentProperty(key: String) {
