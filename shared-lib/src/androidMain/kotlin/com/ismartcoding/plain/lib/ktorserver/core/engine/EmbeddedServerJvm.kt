...
constructor(
    ...
    public val monitor: Events = rootConfig.environment.monitor
    ...
    public val engineConfig: TConfiguration = engineFactory.configuration(engineConfigBlock)
    ...
    public val engine: TEngine = engineFactory.create(
        environment,
        monitor,
        rootConfig.developmentMode,
        engineConfig,
    ...
    public fun stop(gracePeriodMillis: Long = engineConfig.shutdownGracePeriod, timeoutMillis: Long = engineConfig.shutdownTimeout) {
        stop(gracePeriodMillis, timeoutMillis, TimeUnit.MILLISECONDS)
    }

    public suspend fun stopSuspend(gracePeriodMillis: Long = engineConfig.shutdownGracePeriod, timeoutMillis: Long = engineConfig.shutdownTimeout) {
