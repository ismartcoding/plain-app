...
fun String.normalizeString(): String = Normalizer.normalize(this, Normalizer.Form.NFD).replace("\\p{InCombiningDiacriticalMarks}+".toRegex(), "")

fun String.normalizePhoneNumber(): String = PhoneNumberUtils.normalizeNumber(this)

fun String.containsChinese(): Boolean = this.codePoints().anyMatch { codepoint: Int -> Character.UnicodeScript.of(codepoint) == Character.UnicodeScript.HAN }
...
private val typesMap = HashMap<String, String>().apply {
    put("323", "text/h323")
    put("3g2", "video/3gpp2")
    put("3gp", "video/3gpp")
...
fun String.splitInParts(len: Int, splitChars: Array<Char>): Array<String> {
