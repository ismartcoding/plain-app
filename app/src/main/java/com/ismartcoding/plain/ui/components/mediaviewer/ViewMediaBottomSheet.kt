            ...
            item {
                ...
                PCard {
                    ...
                    if (intrinsicSize.width > 0 && intrinsicSize.height > 0) {
                        PListItem(title = stringResource(id = R.string.dimensions), value = "${intrinsicSize.width}x${intrinsicSize.height}")
                    }
                    if (m.data is DImage) {
                        if (m.data.takenAt != null) {
                            PListItem(title = stringResource(id = R.string.taken_at), value = m.data.takenAt.formatDateTime())
                        }
