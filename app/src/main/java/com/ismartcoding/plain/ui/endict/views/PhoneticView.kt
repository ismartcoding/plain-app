...
class PhoneticView(context: Context, attrs: AttributeSet?) : CustomViewBase(context, attrs) {
    ...
    fun initView(lifecycle: Lifecycle, word: String, country: String, phonetic: String) {
        ...
        events.add(receiveEventHandler<PlayAudioResultEvent> { event ->
    ...
    private fun getUri(country: String, word: String): String {
    ...
    private fun playSound(country: String, word: String) {
