...
class SubsamplingScaleImageView2 @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : SubsamplingScaleImageView(context, attrs) {
    ...
    private fun handleDispatchTouchEvent(event: MotionEvent?) {
        when (event?.actionMasked) {
            ...
            MotionEvent.ACTION_UP, MotionEvent.ACTION_CANCEL -> fakeDrag.up(this) {
                setSingleTouch(it)
            }
