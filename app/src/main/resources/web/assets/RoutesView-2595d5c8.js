import{d as ie,B as ce,r as E,u as de,a2 as J,ao as S,b_ as F,b$ as pe,ak as _e,G as me,al as I,o as u,e as r,f as e,t as o,h as l,L as f,c1 as A,F as y,A as k,R as x,am as ee,x as V,y as te,j as U,ar as ve,i as fe,k as ge,a8 as L,c2 as $e,c3 as he,K as be,Y as B,T as ae,g as oe,U as ne,w as se,a9 as ye,a0 as ke}from"./index-d84b2961.js";import{_ as we}from"./Breadcrumb-94ff4433.js";import{T as m,a as w,_ as Ce,A as Te}from"./question-mark-rounded-1417c821.js";import{u as Ne,a as Fe}from"./vee-validate.esm-4c3e0ef1.js";const Ie={slot:"headline"},Ae={slot:"content"},Ee={class:"row mb-3"},Ve={class:"col-md-3 col-form-label"},De={class:"col-md-9"},Re=["value"],Me={key:0,class:"input-group mt-2"},qe=["placeholder"],Oe={class:"inner"},Se={class:"help-block"},Ue={value:""},Le=["value"],Be={key:2,class:"invalid-feedback"},Je={class:"row mb-3"},je={class:"col-md-3 col-form-label"},Pe={class:"col-md-9"},Ge=["value"],Ke={class:"row mb-3"},Qe={class:"col-md-3 col-form-label"},Ye={class:"col-md-9"},ze={value:"all"},He=["value"],We=["value"],Xe={class:"row mb-3"},Ze={class:"col-md-3 col-form-label"},xe={class:"col-md-9"},et={slot:"actions"},tt=["disabled"],le=ie({__name:"EditRouteModal",props:{data:{type:Object},devices:{type:Array},networks:{type:Array}},setup(h){var $,j,P,G,K,Q,Y,z,H;const _=h,{handleSubmit:b}=Ne(),i=ce({if_name:"",apply_to:"all",notes:"",target:"",is_enabled:!0}),p=E(m.INTERNET),D=Object.values(m).filter(s=>[m.IP,m.NET,m.REMOTE_PORT,m.INTERNET].includes(s)),{t:C}=de(),{mutate:R,loading:M,onDone:q}=J({document:S`
