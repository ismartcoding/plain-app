import{d as I,a as y,r as D,u as F,i as M,k as B,a8 as o,bz as g,a2 as q,e as l,f as e,x as f,t,F as A,A as E,o as r,h as $,w as m,n as N,Y as S,a9 as V,a0 as L}from"./index-c29359c5.js";import{_ as P}from"./Breadcrumb-052dbd56.js";import{p as j}from"./parser-fdd85e1d.js";const z={class:"page-container"},Q={class:"main"},Y={class:"table-responsive"},H={class:"table"},J=e("th",null,"ID",-1),K={class:"actions two"},O={class:"form-check"},R=["disabled","onChange","checked"],T={class:"actions two"},U=["onClick"],X=["onClick"],ae=I({__name:"WireGuardView",setup(Z){const b=y(),d=D([]),{t:c}=F();function w(n){N(b,`/wireguard/${n}`)}M({handle:(n,s)=>{s?B(c(s),"error"):d.value=n.wireGuards.map(i=>({...i,...j(i.config)}))},document:o`
    query {
      wireGuards {
        ...WireGuardFragment
      }
