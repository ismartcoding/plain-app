import{d as y,g as A,h as N,l as F,C as I,ac as r,cw as p,c as o,p as m,a as e,t as a,O as _,P as M,S as q,o as i,w as v,x as h,m as d,ap as f,V as $,U as D,Z as w,ad as B,j as E,a3 as S}from"./index-BzaaAwnX.js";import{_ as T}from"./Breadcrumb-Dw4cmHLf.js";import{E as O}from"./EditValueModal-Ws2hdG3a.js";import"./vee-validate.esm-DNjIRPsN.js";const U={class:"table-responsive"},j={class:"table"},L=e("th",null,"ID",-1),P={class:"actions one"},Q=["onClick"],Z={class:"nowrap"},z={class:"nowrap"},G={class:"actions one"},H=["onClick"],Y=y({__name:"DevicesView",setup(J){const{t:s}=A(),c=N([]);F({handle:(t,l)=>{l?I(s(l),"error"):c.value=[...t.devices]},document:r`
    query {
      devices {
        ...DeviceFragment
      }
