import{_ as x}from"./MonacoEditor.vuevuetypescriptsetuptruelang-8c70d17b.js";import{_ as y}from"./EditToolbar.vuevuetypescriptsetuptruelang-b9d2c687.js";import{_ as b}from"./Breadcrumb-6debfc1a.js";import{d as N,u as $,r as s,i as C,t as r,Y as p,be as c,U as h,o as U,c as B,b as F,e as i,g as S,J as d,a2 as g}from"./index-4e7fbfe1.js";const q={class:"page-container container"},D={class:"main"},Q=N({__name:"NetworkView",setup(A){const{t:u}=$(),o=s(0),n=s(""),t=s("");C({handle:(l,e)=>{e?r(u(e),"error"):(n.value=l.networkConfig.netplan,t.value=l.networkConfig.netmix)},document:p`
    query {
      networkConfig {
