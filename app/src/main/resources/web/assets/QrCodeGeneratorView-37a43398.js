import{_ as Y}from"./Breadcrumb-91ff4b3f.js";import{bu as I,d as $,r as M,E as j,e as P,f as C,x as b,y as D,h as S,o as H,J as q,P as tt,j as rt,_ as et}from"./index-71d8bb76.js";import{g as O,M as nt}from"./splitpanes.es-85db08aa.js";/**
* @module QRCode
...
* @description A pure JavaScript QRCode encode and decode library.
* @see https://github.com/nuintun/qrcode#readme
*/var B=[],R=[];for(var w=0;w<256;w++)R[w]=0,B[w]=w<8?1<<w:B[w-4]^B[w-5]^B[w-6]^B[w-8];for(var w=0;w<255;w++)R[B[w]]=w;function x(r){if(r<1)throw new Error("illegal log: ".concat(r));return R[r]}function E(r){for(;r<0;)r+=255;for(;r>=256;)r-=255;return B[r]}/**
* @module QRCode
* @package @nuintun/qrcode
* @license MIT
* @version 3.3.0
...
* @description A pure JavaScript QRCode encode and decode library.
* @see https://github.com/nuintun/qrcode#readme
*/var A=function(){function r(t,e){e===void 0&&(e=0);for(var i=0,n=t.length;i<n&&t[i]===0;)i++;n-=i;for(var a=[],s=0;s<n;s++)a.push(t[i+s]);for(var s=0;s<e;s++)a.push(0);this.num=a}return r.prototype.getAt=function(t){return this.num[t]},r.prototype.getLength=function(){return this.num.length},r.prototype.multiply=function(t){for(var e=[],i=t.getLength(),n=this.getLength(),a=n+i-1,s=0;s<a;s++)e.push(0);for(var s=0;s<n;s++)for(var f=0;f<i;f++)e[s+f]^=E(x(this.getAt(s))+x(t.getAt(f)));return new r(e)},r.prototype.mod=function(t){var e=t.getLength(),i=this.getLength();if(i-e<0)return this;for(var n=x(this.getAt(0))-x(t.getAt(0)),a=[],s=0;s<i;s++)a.push(this.getAt(s));for(var s=0;s<e;s++)a[s]^=E(x(t.getAt(s))+n);return new r(a).mod(t)},r}();/**
* @module QRCode
* @package @nuintun/qrcode
* @license MIT
* @version 3.3.0
