import{_ as k}from"./MonacoEditor.vuevuetypescriptsetuptruelang-WcUH3tOp.js";import{_ as y}from"./EditToolbar.vuevuetypescriptsetuptruelang-BYnXPUga.js";import{_ as $}from"./Breadcrumb-B2BEfhSz.js";import{d as C,g as N,h as u,l as b,C as s,ac as p,bX as g,j as F,c as h,p as m,m as S,x as c,aH as d,O as U,o as q}from"./index-B-S542RM.js";const H=C({__name:"NetworkView",setup(B){const{t:i}=N(),o=u(0),n=u(""),t=u("");b({handle:(l,e)=>{e?s(i(e),"error"):(n.value=l.networkConfig.netplan,t.value=l.networkConfig.netmix)},document:p`
    query {
      networkConfig {
