import{_ as y}from"./MonacoEditor.vuevuetypescriptsetuptruelang-5a0c1f84.js";import{_ as k}from"./EditToolbar.vuevuetypescriptsetuptruelang-d31394e1.js";import{_ as b}from"./Breadcrumb-aaa94fae.js";import{d as N,u as $,r as m,g as C,x as r,ab as p,by as c,i as h,c as B,a as F,p as i,j as S,m as d,aV as g,o as U}from"./index-c1ff76a9.js";const q={class:"page-container"},D={class:"main"},Q=N({__name:"NetworkView",setup(j){const{t:s}=$(),o=m(0),n=m(""),a=m("");C({handle:(l,e)=>{e?r(s(e),"error"):(n.value=l.networkConfig.netplan,a.value=l.networkConfig.netmix)},document:p`
    query {
      networkConfig {
