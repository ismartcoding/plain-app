import{d as ie,K as ce,r as A,u as de,i as j,aq as S,c3 as F,c4 as pe,an as _e,w as ve,ao as I,o as u,c as r,a as e,t as o,j as l,m as f,c6 as E,F as y,J as k,v as x,n as ee,p as V,H as te,k as U,at as me,g as fe,x as ge,ab as J,c7 as $e,c8 as he,R as be,a2 as L,Y as ae,h as oe,Z as ne,l as se,ac as ye,a5 as ke}from"./index-e3113b21.js";import{_ as we}from"./Breadcrumb-66ab2aa6.js";import{T as v,a as w,_ as Ce,A as Te}from"./question-mark-rounded-aab4de5b.js";import{u as Ne,a as Fe}from"./vee-validate.esm-b9fbae6c.js";const Ie={slot:"headline"},Ee={slot:"content"},Ae={class:"row mb-3"},Ve={class:"col-md-3 col-form-label"},De={class:"col-md-9"},Re=["value"],Me={key:0,class:"input-group"},qe=["placeholder"],Oe={class:"inner"},Se={class:"help-block"},Ue={value:""},Je=["value"],Le={key:2,class:"invalid-feedback"},je={class:"row mb-3"},Be={class:"col-md-3 col-form-label"},Pe={class:"col-md-9"},He=["value"],Ke={class:"row mb-3"},Qe={class:"col-md-3 col-form-label"},Ye={class:"col-md-9"},Ze={value:"all"},ze=["value"],Ge=["value"],We={class:"row mb-3"},Xe={class:"col-md-3 col-form-label"},xe={class:"col-md-9"},et={slot:"actions"},tt=["disabled"],le=ie({__name:"EditRouteModal",props:{data:{type:Object},devices:{type:Array},networks:{type:Array}},setup(h){var $,B,P,H,K,Q,Y,Z,z;const _=h,{handleSubmit:b}=Ne(),i=ce({if_name:"",apply_to:"all",notes:"",target:"",is_enabled:!0}),p=A(v.INTERNET),D=Object.values(v).filter(s=>[v.IP,v.NET,v.REMOTE_PORT,v.INTERNET].includes(s)),{t:C}=de(),{mutate:R,loading:M,onDone:q}=j({document:S`
