import{_ as x}from"./MonacoEditor.vuevuetypescriptsetuptruelang-f20d585d.js";import{_ as y}from"./EditToolbar.vuevuetypescriptsetuptruelang-dac3512f.js";import{_ as b}from"./Breadcrumb-7c24ea6b.js";import{d as N,u as $,r as s,i as C,t as r,Y as p,be as c,U as h,o as U,c as B,b as F,e as i,g as S,J as d,a2 as g}from"./index-400f4a7b.js";const q={class:"page-container container"},D={class:"main"},Q=N({__name:"NetworkView",setup(A){const{t:u}=$(),o=s(0),n=s(""),t=s("");C({handle:(l,e)=>{e?r(u(e),"error"):(n.value=l.networkConfig.netplan,t.value=l.networkConfig.netmix)},document:p`
    query {
      networkConfig {
