import{i as e}from"./chunk-aKtaBQYM.js";import{H as t,T as n,_ as r,b as i,g as a}from"./vue.runtime.esm-bundler-DB7W0Wog.js";import{t as o}from"./plugin-vue_export-helper-BDNMzG2s.js";import{t as s}from"./katex-Bde8JeLx.js";import{a as c,c as l,i as u,l as d,n as f,o as p,r as m,s as h,t as g,u as _}from"./markdown-it-task-lists-BO6EiH5K.js";var v=e(d(),1),y=e(l(),1),b=e(h(),1),x=e(p(),1),S=e(c(),1),C=e(u(),1),w=e(m(),1),T=e(f(),1),E=e(g(),1),D={class:`md-preview-page`},O={class:`md-preview-main`},k=[`innerHTML`],A=`# Heading 1
...
`,j=o(n({__name:`MarkdownPreviewView`,setup(e){let n=new _({html:!0,xhtmlOut:!0,breaks:!0,linkify:!0,typographer:!0}).use(v.default).use(y.default).use(b.default).use(x.default).use(S.default).use(C.default).use(w.default).use(T.default,{engine:s,delimiters:`dollars`,katexOptions:{output:`html`}}).use(E.default,{enabled:!0}),o=a(()=>n.render(A));return(e,n)=>(t(),i(`div`,D,[n[0]||=r(`header`,{class:`md-preview-header`},[r(`h1`,null,`Markdown Preview`)],-1),r(`main`,O,[r(`div`,{class:`md-container`,innerHTML:o.value},null,8,k)])]))}}),[[`__scopeId`,`data-v-8d6dfba0`]]);export{j as default};