import{_ as w}from"./FieldId-a09be666.js";import{_ as b}from"./Breadcrumb-55791723.js";import{d as y,u as A,r as C,i as F,t as V,Y as i,bh as u,o as r,c as d,b as e,e as m,f as a,F as I,y as N,w as p,g as l,O as _,P as f,X as h,U as q}from"./index-3c761cf5.js";import{_ as B}from"./DeleteConfirm.vuevuetypescriptsetuptruelang-c5faeb69.js";import{_ as M}from"./EditValueModal.vuevuetypescriptsetuptruelang-7d8bcc18.js";import"./VModal.vuevuetypescriptsetuptruelang-d5392689.js";import"./vee-validate.esm-7f7a9a56.js";const O={class:"page-container container"},S={class:"main"},T={class:"table"},U=e("th",null,"ID",-1),E={class:"actions one"},L=["onClick"],P=["title"],Q=["title"],X={class:"actions one"},Y=["onClick"],Z=y({__name:"DevicesView",setup(j){const{t:s}=A(),c=C([]);F({handle:(n,o)=>{o?V(s(o),"error"):c.value=[...n.devices]},document:i`
    query {
      devices {
        ...DeviceFragment
      }
