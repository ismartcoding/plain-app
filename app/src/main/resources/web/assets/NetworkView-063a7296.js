import{_ as x}from"./MonacoEditor.vuevuetypescriptsetuptruelang-356f0a60.js";import{_ as y}from"./EditToolbar.vuevuetypescriptsetuptruelang-a0ec01d8.js";import{_ as b}from"./Breadcrumb-2d9a8da6.js";import{d as N,u as $,r as s,i as C,t as r,Z as p,bg as c,V as h,o as B,c as F,b as S,e as i,g as U,K as d,a6 as g}from"./index-e9c32210.js";const q={class:"page-container container"},D={class:"main"},Q=N({__name:"NetworkView",setup(A){const{t:u}=$(),o=s(0),n=s(""),t=s("");C({handle:(l,e)=>{e?r(u(e),"error"):(n.value=l.networkConfig.netplan,t.value=l.networkConfig.netmix)},document:p`
    query {
      networkConfig {
