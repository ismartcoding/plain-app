import{d as ie,B as ce,r as E,u as de,a1 as B,am as S,bW as F,bX as pe,ai as _e,G as me,aj as I,o as u,e as r,f as e,t as o,h as l,L as f,bZ as A,F as y,A as k,R as x,ak as ee,x as V,y as te,j as U,ap as ve,i as fe,k as ge,a7 as L,b_ as $e,b$ as he,K as be,X as j,T as ae,g as oe,U as ne,w as se,a8 as ye,$ as ke}from"./index-eee88ba0.js";import{_ as we}from"./Breadcrumb-7edea612.js";import{T as m,a as w,_ as Ce,A as Te}from"./question-mark-rounded-c596cb62.js";import{u as Ne,a as Fe}from"./vee-validate.esm-47465a3b.js";const Ie={slot:"headline"},Ae={slot:"content"},Ee={class:"row mb-3"},Ve={class:"col-md-3 col-form-label"},De={class:"col-md-9"},Re=["value"],Me={key:0,class:"input-group mt-2"},qe=["placeholder"],Oe={class:"inner"},Se={class:"help-block"},Ue={value:""},Le=["value"],je={key:2,class:"invalid-feedback"},Be={class:"row mb-3"},Je={class:"col-md-3 col-form-label"},Pe={class:"col-md-9"},Xe=["value"],Ge={class:"row mb-3"},Ke={class:"col-md-3 col-form-label"},Qe={class:"col-md-9"},We={value:"all"},Ze=["value"],ze=["value"],He={class:"row mb-3"},Ye={class:"col-md-3 col-form-label"},xe={class:"col-md-9"},et={slot:"actions"},tt=["disabled"],le=ie({__name:"EditRouteModal",props:{data:{type:Object},devices:{type:Array},networks:{type:Array}},setup(h){var $,J,P,X,G,K,Q,W,Z;const _=h,{handleSubmit:b}=Ne(),i=ce({if_name:"",apply_to:"all",notes:"",target:"",is_enabled:!0}),p=E(m.INTERNET),D=Object.values(m).filter(s=>[m.IP,m.NET,m.REMOTE_PORT,m.INTERNET].includes(s)),{t:C}=de(),{mutate:R,loading:M,onDone:q}=B({document:S`
