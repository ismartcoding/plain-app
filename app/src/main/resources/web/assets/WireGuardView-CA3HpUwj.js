import{d as y,u as D,h as M,g as B,l as F,C as q,ac as o,bW as g,j as E,c as r,p as f,a as e,t,O as $,P as N,o as i,m,w as b,f as P,Z as S,ad as V,a3 as j}from"./index-Dn0O6zoH.js";import{_ as A}from"./Breadcrumb-nTZpptou.js";import{p as L}from"./parser-DNY2aV9Q.js";const O={class:"table-responsive"},Q={class:"table"},Z=e("th",null,"ID",-1),z={class:"actions two"},H={class:"form-check"},J=["disabled","onChange","checked"],K={class:"actions two"},R=["onClick"],T=["onClick"],ee=y({__name:"WireGuardView",setup(U){const w=D(),d=M([]),{t:u}=B();function k(n){P(w,`/wireguard/${n}`)}F({handle:(n,s)=>{s?q(u(s),"error"):d.value=n.wireGuards.map(l=>({...l,...L(l.config)}))},document:o`
    query {
      wireGuards {
        ...WireGuardFragment
      }
