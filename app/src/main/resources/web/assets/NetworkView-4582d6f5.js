import{_ as k}from"./MonacoEditor.vuevuetypescriptsetuptruelang-02a4c7d4.js";import{_ as y}from"./EditToolbar.vuevuetypescriptsetuptruelang-8326a291.js";import{_ as b}from"./Breadcrumb-c6d997c6.js";import{d as N,u as $,r as m,g as C,x as r,ab as p,bD as c,i as h,c as B,a as D,p as i,j as F,m as d,aW as g,o as S}from"./index-88e9bec4.js";const U={class:"page-container"},q={class:"main"},Q=N({__name:"NetworkView",setup(j){const{t:s}=$(),o=m(0),n=m(""),a=m("");C({handle:(l,e)=>{e?r(s(e),"error"):(n.value=l.networkConfig.netplan,a.value=l.networkConfig.netmix)},document:p`
    query {
      networkConfig {
