import{d as y,g as A,h as N,l as F,C as I,ac as r,cs as m,c as o,p,a as e,t as a,O as _,P as M,S as q,o as i,w as v,x as h,m as d,an as f,V as $,U as D,Z as g,ad as B,j as E,a3 as S}from"./index-B-S542RM.js";import{_ as T}from"./Breadcrumb-B2BEfhSz.js";import{E as O}from"./EditValueModal-u3M261_O.js";import"./vee-validate.esm-D5u4WlYW.js";const U={class:"table-responsive"},j={class:"table"},L=e("th",null,"ID",-1),P={class:"actions one"},Q=["onClick"],Z={class:"nowrap"},z={class:"nowrap"},G={class:"actions one"},H=["onClick"],Y=y({__name:"DevicesView",setup(J){const{t:s}=A(),c=N([]);F({handle:(n,l)=>{l?I(s(l),"error"):c.value=[...n.devices]},document:r`
    query {
      devices {
        ...DeviceFragment
      }
