import{d as ie,K as ce,r as A,u as de,i as j,aq as S,b_ as F,b$ as pe,g as _e,O as me,ao as I,o as u,c as r,a as e,t as o,k as l,m as f,c1 as E,F as y,J as k,v as x,n as ee,p as V,H as te,l as U,at as ve,h as fe,x as ge,ac as J,c2 as $e,c3 as he,S as be,a3 as L,Z as ae,j as oe,$ as ne,w as se,ad as ye,a6 as ke}from"./index-53a7b7bf.js";import{_ as we}from"./Breadcrumb-ae8ab346.js";import{T as m,a as w,_ as Ce,A as Te}from"./question-mark-rounded-d1ec4a35.js";import{u as Ne,a as Fe}from"./vee-validate.esm-18d571e0.js";const Ie={slot:"headline"},Ee={slot:"content"},Ae={class:"row mb-3"},Ve={class:"col-md-3 col-form-label"},De={class:"col-md-9"},Re=["value"],Me={key:0,class:"input-group mt-2"},qe=["placeholder"],Oe={class:"inner"},Se={class:"help-block"},Ue={value:""},Je=["value"],Le={key:2,class:"invalid-feedback"},je={class:"row mb-3"},Be={class:"col-md-3 col-form-label"},Pe={class:"col-md-9"},He=["value"],Ke={class:"row mb-3"},Qe={class:"col-md-3 col-form-label"},Ze={class:"col-md-9"},ze={value:"all"},Ge=["value"],We=["value"],Xe={class:"row mb-3"},Ye={class:"col-md-3 col-form-label"},xe={class:"col-md-9"},et={slot:"actions"},tt=["disabled"],le=ie({__name:"EditRouteModal",props:{data:{type:Object},devices:{type:Array},networks:{type:Array}},setup(h){var $,B,P,H,K,Q,Z,z,G;const _=h,{handleSubmit:b}=Ne(),i=ce({if_name:"",apply_to:"all",notes:"",target:"",is_enabled:!0}),p=A(m.INTERNET),D=Object.values(m).filter(s=>[m.IP,m.NET,m.REMOTE_PORT,m.INTERNET].includes(s)),{t:C}=de(),{mutate:R,loading:M,onDone:q}=j({document:S`
