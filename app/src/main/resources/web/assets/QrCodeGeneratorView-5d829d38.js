import{_ as Y}from"./Breadcrumb-120bdd32.js";import{bs as I,d as $,r as M,J as j,o as P,c as O,e as C,x as b,y as D,j as S,O as q,P as tt,l as rt,_ as et}from"./index-df35a132.js";import{g as H,M as nt}from"./splitpanes.es-c959884b.js";/**
* @module QRCode
...
* @description A pure JavaScript QRCode encode and decode library.
* @see https://github.com/nuintun/qrcode#readme
*/var at=function(r){I(t,r);function t(e,i){var n=r.call(this,p.Byte,e)||this;if(n.encoding=-1,typeof i=="function"){var a=i(e),s=a.encoding,f=a.bytes;n.bytes=f,n.encoding=s}else n.bytes=it(e),n.encoding=26;return n}return t.prototype.writeTo=function(e){for(var i=this.bytes,n=0,a=i;n<a.length;n++){var s=a[n];e.put(s,8)}},t}(Q);/**
* @module QRCode
* @package @nuintun/qrcode
* @license MIT
* @version 3.3.0
...
* @description A pure JavaScript QRCode encode and decode library.
* @see https://github.com/nuintun/qrcode#readme
*/var B=[],R=[];for(var w=0;w<256;w++)R[w]=0,B[w]=w<8?1<<w:B[w-4]^B[w-5]^B[w-6]^B[w-8];for(var w=0;w<255;w++)R[B[w]]=w;function x(r){if(r<1)throw new Error("illegal log: ".concat(r));return R[r]}function A(r){for(;r<0;)r+=255;for(;r>=256;)r-=255;return B[r]}/**
* @module QRCode
* @package @nuintun/qrcode
* @license MIT
* @version 3.3.0
...
* @description A pure JavaScript QRCode encode and decode library.
* @see https://github.com/nuintun/qrcode#readme
*/var E=function(){function r(t,e){e===void 0&&(e=0);for(var i=0,n=t.length;i<n&&t[i]===0;)i++;n-=i;for(var a=[],s=0;s<n;s++)a.push(t[i+s]);for(var s=0;s<e;s++)a.push(0);this.num=a}return r.prototype.getAt=function(t){return this.num[t]},r.prototype.getLength=function(){return this.num.length},r.prototype.multiply=function(t){for(var e=[],i=t.getLength(),n=this.getLength(),a=n+i-1,s=0;s<a;s++)e.push(0);for(var s=0;s<n;s++)for(var f=0;f<i;f++)e[s+f]^=A(x(this.getAt(s))+x(t.getAt(f)));return new r(e)},r.prototype.mod=function(t){var e=t.getLength(),i=this.getLength();if(i-e<0)return this;for(var n=x(this.getAt(0))-x(t.getAt(0)),a=[],s=0;s<i;s++)a.push(this.getAt(s));for(var s=0;s<e;s++)a[s]^=A(x(t.getAt(s))+n);return new r(a).mod(t)},r}();/**
* @module QRCode
* @package @nuintun/qrcode
* @license MIT
* @version 3.3.0
...
* @description A pure JavaScript QRCode encode and decode library.
* @see https://github.com/nuintun/qrcode#readme
*/var st=3,ot=3,N=40,ft=10,ut=[[],[6,18],[6,22],[6,26],[6,30],[6,34],[6,22,38],[6,24,42],[6,26,46],[6,28,50],[6,30,54],[6,32,58],[6,34,62],[6,26,46,66],[6,26,48,70],[6,26,50,74],[6,30,54,78],[6,30,56,82],[6,30,58,86],[6,34,62,90],[6,28,50,72,94],[6,26,50,74,98],[6,30,54,78,102],[6,28,54,80,106],[6,32,58,84,110],[6,30,58,86,114],[6,34,62,90,118],[6,26,50,74,98,122],[6,30,54,78,102,126],[6,26,52,78,104,130],[6,30,56,82,108,134],[6,34,60,86,112,138],[6,30,58,86,114,142],[6,34,62,90,118,146],[6,30,54,78,102,126,150],[6,24,50,76,102,128,154],[6,28,54,80,106,132,158],[6,32,58,84,110,136,162],[6,26,54,82,110,138,166],[6,30,58,86,114,142,170]],ht=1<<14|1<<12|1<<10|1<<4|1<<1,U=1<<10|1<<8|1<<5|1<<4|1<<2|1<<1|1<<0,W=1<<12|1<<11|1<<10|1<<9|1<<8|1<<5|1<<2|1<<0;function vt(r){return ut[r-1]}function lt(r){for(var t=new E([1]),e=0;e<r;e++)t=t.multiply(new E([1,A(e)]));return t}function L(r){for(var t=0;r!==0;)t++,r>>>=1;return t}var V=L(W);function ct(r){for(var t=r<<12;L(t)-V>=0;)t^=W<<L(t)-V;return r<<12|t}var G=L(U);function pt(r){for(var t=r<<10;L(t)-G>=0;)t^=U<<L(t)-G;return(r<<10|t)^ht}function F(r,t){for(var e=r.getMatrixSize(),i=0,n=0;n<e;n++)for(var a=!1,s=0,f=0;f<e;f++){var u=t?r.isDark(n,f):r.isDark(f,n);u===a?(s++,s===5?i+=st:s>5&&i++):(a=u,s=1)}return i}function gt(r){return F(r,!0)+F(r,!1)}function wt(r){for(var t=r.getMatrixSize(),e=0,i=0;i<t-1;i++)for(var n=0;n<t-1;n++){var a=r.isDark(i,n);a===r.isDark(i,n+1)&&a===r.isDark(i+1,n)&&a===r.isDark(i+1,n+1)&&(e+=ot)}return e}function k(r,t,e,i,n){e=Math.max(e,0),i=Math.min(i,r.getMatrixSize());for(var a=e;a<i;a++){var s=n?r.isDark(t,a):r.isDark(a,t);if(s)return!1}return!0}function mt(r){for(var t=r.getMatrixSize(),e=0,i=0;i<t;i++)for(var n=0;n<t;n++)n+6<t&&r.isDark(i,n)&&!r.isDark(i,n+1)&&r.isDark(i,n+2)&&r.isDark(i,n+3)&&r.isDark(i,n+4)&&!r.isDark(i,n+5)&&r.isDark(i,n+6)&&(k(r,i,n-4,n,!0)||k(r,i,n+7,n+11,!0))&&(e+=N),i+6<t&&r.isDark(i,n)&&!r.isDark(i+1,n)&&r.isDark(i+2,n)&&r.isDark(i+3,n)&&r.isDark(i+4,n)&&!r.isDark(i+5,n)&&r.isDark(i+6,n)&&(k(r,n,i-4,i,!1)||k(r,n,i+7,i+11,!1))&&(e+=N);return e}function yt(r){for(var t=r.getMatrixSize(),e=0,i=0;i<t;i++)for(var n=0;n<t;n++)r.isDark(i,n)&&e++;var a=t*t,s=Math.floor(Math.abs(e*20-a*10)/a);return s*ft}function Bt(r){return gt(r)+wt(r)+mt(r)+yt(r)}/**
* @module QRCode
* @package @nuintun/qrcode
* @license MIT
* @version 3.3.0
...
* @description A pure JavaScript QRCode encode and decode library.
* @see https://github.com/nuintun/qrcode#readme
*/var d=function(r){I(t,r);function t(){var e=r!==null&&r.apply(this,arguments)||this;return e.bytes=[],e}return t.prototype.writeByte=function(e){this.bytes.push(e)},t.prototype.writeInt16=function(e){this.bytes.push(e,e>>>8)},t.prototype.toByteArray=function(){return this.bytes},t}(X);/**
* @module QRCode
* @package @nuintun/qrcode
* @license MIT
* @version 3.3.0
...
* @description A pure JavaScript QRCode encode and decode library.
* @see https://github.com/nuintun/qrcode#readme
*/function xt(r){if(r>=0){if(r<26)return 65+r;if(r<52)return 97+(r-26);if(r<62)return 48+(r-52);if(r===62)return 43;if(r===63)return 47}throw new Error("illegal char: ".concat(String.fromCharCode(r)))}var _t=function(r){I(t,r);function t(e){var i=r.call(this)||this;return i.buffer=0,i.length=0,i.bufLength=0,i.stream=e,i}return t.prototype.writeByte=function(e){for(this.buffer=this.buffer<<8|e&255,this.bufLength+=8,this.length++;this.bufLength>=6;)this.writeEncoded(this.buffer>>>this.bufLength-6),this.bufLength-=6},t.prototype.flush=function(){this.bufLength>0&&(this.writeEncoded(this.buffer<<6-this.bufLength),this.buffer=0,this.bufLength=0);var e=this.stream;if(this.length%3!=0)for(var i=3-this.length%3,n=0;n<i;n++)e.writeByte(61)},t.prototype.writeEncoded=function(e){this.stream.writeByte(xt(e&63))},t}(X);/**
* @module QRCode
* @package @nuintun/qrcode
* @license MIT
* @version 3.3.0
...
* @description A pure JavaScript QRCode encode and decode library.
* @see https://github.com/nuintun/qrcode#readme
*/var At=236,Et=17,dt=Object.prototype.toString;function It(r,t){if(r<0||r>=1e6)throw new Error("byte mode encoding hint out of range");t.put(p.ECI,4),r<1<<7?t.put(r,8):r<1<<14?(t.put(2,2),t.put(r,14)):(t.put(6,3),t.put(r,21))}function K(r,t,e,i){for(var n=new Z,a=Lt.getRSBlocks(r,t),s=0,f=i;s<f.length;s++){var u=f[s],o=u.mode;e&&o===p.Byte&&It(u.encoding,n),n.put(o,4),n.put(u.getLength(),u.getLengthInBits(r)),u.writeTo(n)}for(var v=0,l=0,m=a;l<m.length;l++){var h=m[l];v+=h.getDataCount()}return v*=8,[n,a,v]}function Rt(r,t){for(var e=0,i=0,n=0,a=[],s=[],f=t.length,u=r.getBuffer(),o=0;o<f;o++){var v=t[o],l=v.getDataCount(),m=v.getTotalCount()-l;i=Math.max(i,l),n=Math.max(n,m),a[o]=[];for(var h=0;h<l;h++)a[o][h]=255&u[h+e];e+=l;var c=lt(m),g=c.getLength()-1,_=new E(a[o],g),T=_.mod(c),J=T.getLength();s[o]=[];for(var h=0;h<g;h++){var z=h+J-g;s[o][h]=z>=0?T.getAt(z):0}}r=new Z;for(var h=0;h<i;h++)for(var o=0;o<f;o++)h<a[o].length&&r.put(a[o][h],8);for(var h=0;h<n;h++)for(var o=0;o<f;o++)h<s[o].length&&r.put(s[o][h],8);return r}function Tt(r,t,e){for(r.getLengthInBits()+4<=e&&r.put(0,4);r.getLengthInBits()%8!==0;)r.putBit(!1);for(;!(r.getLengthInBits()>=e||(r.put(At,8),r.getLengthInBits()>=e));)r.put(Et,8);return Rt(r,t)}var zt=function(){function r(t){t===void 0&&(t={}),this.matrixSize=0,this.chunks=[],this.matrix=[];var e=t.version,i=e===void 0?0:e,n=t.encodingHint,a=n===void 0?!1:n,s=t.errorCorrectionLevel,f=s===void 0?y.L:s;this.setVersion(i),this.setEncodingHint(a),this.setErrorCorrectionLevel(f)}return r.prototype.getMatrix=function(){return this.matrix},r.prototype.getMatrixSize=function(){return this.matrixSize},r.prototype.getVersion=function(){return this.version},r.prototype.setVersion=function(t){return this.version=Math.min(40,Math.max(0,t>>0)),this.auto=this.version===0,this},r.prototype.getErrorCorrectionLevel=function(){return this.errorCorrectionLevel},r.prototype.setErrorCorrectionLevel=function(t){switch(t){case y.L:case y.M:case y.Q:case y.H:this.errorCorrectionLevel=t}return this},r.prototype.getEncodingHint=function(){return this.encodingHint},r.prototype.setEncodingHint=function(t){return this.encodingHint=t,this},r.prototype.write=function(t){var e=this.chunks;if(t instanceof Q)e.push(t);else{var i=dt.call(t);if(i==="[object String]")e.push(new at(t));else throw new Error("illegal data: ".concat(t))}return this},r.prototype.isDark=function(t,e){return this.matrix[t][e]===!0},r.prototype.setupFinderPattern=function(t,e){for(var i=this.matrix,n=this.matrixSize,a=-1;a<=7;a++)for(var s=-1;s<=7;s++)t+a<=-1||n<=t+a||e+s<=-1||n<=e+s||(0<=a&&a<=6&&(s===0||s===6)||0<=s&&s<=6&&(a===0||a===6)||2<=a&&a<=4&&2<=s&&s<=4?i[t+a][e+s]=!0:i[t+a][e+s]=!1)},r.prototype.setupAlignmentPattern=function(){for(var t=this.matrix,e=vt(this.version),i=e.length,n=0;n<i;n++)for(var a=0;a<i;a++){var s=e[n],f=e[a];if(t[s][f]===null)for(var u=-2;u<=2;u++)for(var o=-2;o<=2;o++)u===-2||u===2||o===-2||o===2||u===0&&o===0?t[s+u][f+o]=!0:t[s+u][f+o]=!1}},r.prototype.setupTimingPattern=function(){for(var t=this.matrix,e=this.matrixSize-8,i=8;i<e;i++){var n=i%2===0;t[i][6]===null&&(t[i][6]=n),t[6][i]===null&&(t[6][i]=n)}},r.prototype.setupFormatInfo=function(t){for(var e=this.matrix,i=this.errorCorrectionLevel<<3|t,n=pt(i),a=this.matrixSize,s=0;s<15;s++){var f=(n>>s&1)===1;s<6?e[s][8]=f:s<8?e[s+1][8]=f:e[a-15+s][8]=f,s<8?e[8][a-s-1]=f:s<9?e[8][15-s-1+1]=f:e[8][15-s-1]=f}e[a-8][8]=!0},r.prototype.setupVersionInfo=function(){if(this.version>=7)for(var t=this.matrix,e=this.matrixSize,i=ct(this.version),n=0;n<18;n++){var a=(i>>n&1)===1;t[n/3>>0][n%3+e-8-3]=a,t[n%3+e-8-3][n/3>>0]=a}},r.prototype.setupCodewords=function(t,e){for(var i=this.matrix,n=this.matrixSize,a=t.getLengthInBits(),s=St(e),f=0,u=n-1;u>=1;u-=2){u===6&&(u=5);for(var o=0;o<n;o++)for(var v=0;v<2;v++){var l=u-v,m=(u+1&2)===0,h=m?n-1-o:o;if(i[h][l]===null){var c=!1;f<a&&(c=t.getBit(f++));var g=s(l,h);g&&(c=!c),i[h][l]=c}}}},r.prototype.buildMatrix=function(t,e){for(var i=[],n=this.matrixSize,a=0;a<n;a++){i[a]=[];for(var s=0;s<n;s++)i[a][s]=null}this.matrix=i,this.setupFinderPattern(0,0),this.setupFinderPattern(n-7,0),this.setupFinderPattern(0,n-7),this.setupAlignmentPattern(),this.setupTimingPattern(),this.setupFormatInfo(e),this.setupVersionInfo(),this.setupCodewords(t,e)},r.prototype.make=function(){var t,e,i,n,a,s=this,f=s.chunks,u=s.errorCorrectionLevel;if(this.auto){for(var o=1;o<=40&&(t=K(o,u,this.encodingHint,f),i=t[0],n=t[1],a=t[2],!(i.getLengthInBits()<=a));o++);var v=i.getLengthInBits();if(v>a)throw new Error("data overflow: ".concat(v," > ").concat(a));this.version=o}else e=K(this.version,u,this.encodingHint,f),i=e[0],n=e[1],a=e[2];this.matrixSize=this.version*4+17;for(var l=[],m=Tt(i,n,a),h=-1,c=Number.MAX_VALUE,g=0;g<8;g++){this.buildMatrix(m,g),l.push(this.matrix);var _=Bt(this);_<c&&(c=_,h=g)}return this.matrix=l[h],this},r.prototype.toDataURL=function(t,e){t===void 0&&(t=2),e===void 0&&(e=t*4),t=Math.max(1,t>>0),e=Math.max(0,e>>0);for(var i=this.matrixSize,n=t*i+e*2,a=e,s=n-e,f=new Dt(n,n),u=0;u<n;u++)for(var o=0;o<n;o++)if(a<=o&&o<s&&a<=u&&u<s){var v=(u-a)/t>>0,l=(o-a)/t>>0;f.setPixel(o,u,this.isDark(v,l)?0:1)}else f.setPixel(o,u,1);return f.toDataURL()},r.prototype.clear=function(){this.chunks=[]},r}();const Mt={class:"page-container"},Pt={class:"main"},Ot={class:"v-toolbar"},Ht=["src"],Nt=$({__name:"QrCodeGeneratorView",setup(r){const t=M(""),e=M("");return j(t,i=>{try{const n=new zt;n.setEncodingHint(!0),n.setErrorCorrectionLevel(y.H),n.write(i),n.make(),e.value=n.toDataURL(8)}catch{}}),(i,n)=>{const a=Y;return P(),O("div",Mt,[C("div",Pt,[C("div",Ot,[b(a,{current:()=>i.$t("qrcode_generator")},null,8,["current"])]),b(S(nt),{class:"panel-container"},{default:D(()=>[b(S(H),null,{default:D(()=>[q(C("md-outlined-text-field",{type:"textarea",rows:"3","onUpdate:modelValue":n[0]||(n[0]=s=>t.value=s)},null,512),[[tt,t.value]])]),_:1}),b(S(H),{class:"qrcode-panel"},{default:D(()=>[e.value?(P(),O("img",{key:0,src:e.value},null,8,Ht)):rt("",!0)]),_:1})]),_:1})])])}}});const Kt=et(Nt,[["__scopeId","data-v-ca62344b"]]);export{Kt as default};
