import{_ as J}from"./Breadcrumb-db40a1f3.js";import{bn as R,d as Y,s as $,a as j,r as q,G as tt,e as z,f as S,x as b,y as D,h as k,o as P,L as rt,R as et,ak as nt,j as it,_ as at}from"./index-391e08bf.js";import{g as H,M as st}from"./splitpanes.es-e975dd23.js";/**
* @module QRCode
...
* @description A pure JavaScript QRCode encode and decode library.
* @see https://github.com/nuintun/qrcode#readme
*/var ft=function(r){R(t,r);function t(e,i){var n=r.call(this,p.Byte,e)||this;if(n.encoding=-1,typeof i=="function"){var a=i(e),s=a.encoding,f=a.bytes;n.bytes=f,n.encoding=s}else n.bytes=ot(e),n.encoding=26;return n}return t.prototype.writeTo=function(e){for(var i=this.bytes,n=0,a=i;n<a.length;n++){var s=a[n];e.put(s,8)}},t}(K);/**
* @module QRCode
* @package @nuintun/qrcode
* @license MIT
* @version 3.3.0
...
* @description A pure JavaScript QRCode encode and decode library.
* @see https://github.com/nuintun/qrcode#readme
*/var B=[],I=[];for(var w=0;w<256;w++)I[w]=0,B[w]=w<8?1<<w:B[w-4]^B[w-5]^B[w-6]^B[w-8];for(var w=0;w<255;w++)I[B[w]]=w;function x(r){if(r<1)throw new Error("illegal log: ".concat(r));return I[r]}function d(r){for(;r<0;)r+=255;for(;r>=256;)r-=255;return B[r]}/**
* @module QRCode
* @package @nuintun/qrcode
* @license MIT
* @version 3.3.0
...
* @description A pure JavaScript QRCode encode and decode library.
* @see https://github.com/nuintun/qrcode#readme
*/var E=function(r){R(t,r);function t(){var e=r!==null&&r.apply(this,arguments)||this;return e.bytes=[],e}return t.prototype.writeByte=function(e){this.bytes.push(e)},t.prototype.writeInt16=function(e){this.bytes.push(e,e>>>8)},t.prototype.toByteArray=function(){return this.bytes},t}(Z);/**
* @module QRCode
* @package @nuintun/qrcode
* @license MIT
* @version 3.3.0
...
* @description A pure JavaScript QRCode encode and decode library.
* @see https://github.com/nuintun/qrcode#readme
*/function kt(r){if(r>=0){if(r<26)return 65+r;if(r<52)return 97+(r-26);if(r<62)return 48+(r-52);if(r===62)return 43;if(r===63)return 47}throw new Error("illegal char: ".concat(String.fromCharCode(r)))}var Ct=function(r){R(t,r);function t(e){var i=r.call(this)||this;return i.buffer=0,i.length=0,i.bufLength=0,i.stream=e,i}return t.prototype.writeByte=function(e){for(this.buffer=this.buffer<<8|e&255,this.bufLength+=8,this.length++;this.bufLength>=6;)this.writeEncoded(this.buffer>>>this.bufLength-6),this.bufLength-=6},t.prototype.flush=function(){this.bufLength>0&&(this.writeEncoded(this.buffer<<6-this.bufLength),this.buffer=0,this.bufLength=0);var e=this.stream;if(this.length%3!=0)for(var i=3-this.length%3,n=0;n<i;n++)e.writeByte(61)},t.prototype.writeEncoded=function(e){this.stream.writeByte(kt(e&63))},t}(Z);/**
* @module QRCode
* @package @nuintun/qrcode
* @license MIT
* @version 3.3.0
