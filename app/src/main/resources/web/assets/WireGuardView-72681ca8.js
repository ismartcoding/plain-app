import{d as I,a as y,r as D,u as F,i as M,k as B,a8 as o,bZ as g,a2 as q,e as l,f as e,x as f,t,F as A,A as E,o as r,h as $,w as m,n as N,Y as S,a9 as V,a0 as L}from"./index-d84b2961.js";import{_ as P}from"./Breadcrumb-94ff4433.js";import{p as j}from"./parser-fdd85e1d.js";const Q={class:"page-container"},Y={class:"main"},Z={class:"table-responsive"},z={class:"table"},H=e("th",null,"ID",-1),J={class:"actions two"},K={class:"form-check"},O=["disabled","onChange","checked"],R={class:"actions two"},T=["onClick"],U=["onClick"],ae=I({__name:"WireGuardView",setup(X){const b=y(),d=D([]),{t:c}=F();function w(n){N(b,`/wireguard/${n}`)}M({handle:(n,s)=>{s?B(c(s),"error"):d.value=n.wireGuards.map(i=>({...i,...j(i.config)}))},document:o`
    query {
      wireGuards {
        ...WireGuardFragment
      }
