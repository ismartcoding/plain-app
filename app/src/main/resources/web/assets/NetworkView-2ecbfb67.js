import{_ as k}from"./MonacoEditor.vuevuetypescriptsetuptruelang-ac6c29d1.js";import{_ as y}from"./EditToolbar.vuevuetypescriptsetuptruelang-2b6e4f59.js";import{_ as b}from"./Breadcrumb-aba0acda.js";import{d as N,u as $,r as m,g as C,x as r,ab as p,bD as c,i as h,c as B,a as D,p as i,j as F,m as d,aW as g,o as S}from"./index-12f7ec65.js";const U={class:"page-container"},q={class:"main"},Q=N({__name:"NetworkView",setup(j){const{t:s}=$(),o=m(0),n=m(""),a=m("");C({handle:(l,e)=>{e?r(s(e),"error"):(n.value=l.networkConfig.netplan,a.value=l.networkConfig.netmix)},document:p`
    query {
      networkConfig {
