import{_ as x}from"./onacoditor.vuevuetypescriptsetuptruelang-56f9c3d2.js";import{_ as y}from"./ditoolbar.vuevuetypescriptsetuptruelang-9461e700.js";import{_ as N}from"./readcrumb-ccb81e51.js";import{d as $,u as b,r as s,i as C,t as r,a2 as p,bp as c,Z as h,o as B,c as F,e as S,f as i,j as U,N as d,ae as g}from"./inde-e40fd5ce.js";const q={class:"page-container container"},D={class:"main"},Q=$({__name:"NetworkView",setup(j){const{t:u}=b(),o=s(0),n=s(""),t=s("");C({handle:(l,e)=>{e?r(u(e),"error"):(n.value=l.networkConfig.netplan,t.value=l.networkConfig.netmix)},document:p`
    query {
      networkConfig {
