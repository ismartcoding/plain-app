import{d as A,u as y,r as C,i as F,k as N,a7 as r,c0 as p,J as I,e as o,f as e,x as _,t as a,F as M,A as T,o as i,w as m,K as v,h as d,S as h,g as $,T as f,W as D,a8 as q,a1 as B,$ as E}from"./index-642041e3.js";import{_ as S}from"./Breadcrumb-ace66a87.js";import{E as J}from"./EditValueModal-943d0742.js";import"./vee-validate.esm-805f179c.js";const K={class:"page-container"},L={class:"main"},O={class:"table-responsive"},Q={class:"table"},U=e("th",null,"ID",-1),W={class:"actions one"},j=["onClick"],z={class:"nowrap"},G={class:"nowrap"},H={class:"actions one"},P=["onClick"],ee=A({__name:"DevicesView",setup(R){const{t:s}=y(),c=C([]);F({handle:(n,l)=>{l?N(s(l),"error"):c.value=[...n.devices]},document:r`
    query {
      devices {
        ...DeviceFragment
      }
