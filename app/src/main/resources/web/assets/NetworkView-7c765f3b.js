import{_ as x}from"./MonacoEditor.vuevuetypescriptsetuptruelang-169a0ae9.js";import{_ as y}from"./EditToolbar.vuevuetypescriptsetuptruelang-4d61d646.js";import{_ as b}from"./Breadcrumb-7edea612.js";import{d as N,u as $,r as s,i as C,k as r,a7 as p,bs as d,a1 as h,e as B,f as F,x as i,h as S,L as c,bt as g,o as U}from"./index-eee88ba0.js";const q={class:"page-container"},D={class:"main"},Q=N({__name:"NetworkView",setup(A){const{t:u}=$(),o=s(0),n=s(""),t=s("");C({handle:(l,e)=>{e?r(u(e),"error"):(n.value=l.networkConfig.netplan,t.value=l.networkConfig.netmix)},document:p`
    query {
      networkConfig {
