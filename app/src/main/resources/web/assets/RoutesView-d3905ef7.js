import{d as ie,K as ce,r as A,u as de,i as j,aq as S,b_ as F,b$ as pe,an as _e,w as me,ao as I,o as u,c as r,a as e,t as o,j as l,m as f,c1 as E,F as y,J as k,v as x,n as ee,p as V,H as te,k as U,at as ve,g as fe,x as ge,ab as J,c2 as $e,c3 as he,R as be,a2 as L,Y as ae,h as oe,Z as ne,l as se,ac as ye,a5 as ke}from"./index-5e07ed19.js";import{_ as we}from"./Breadcrumb-91f57f67.js";import{T as m,a as w,_ as Ce,A as Te}from"./question-mark-rounded-ff33b77d.js";import{u as Ne,a as Fe}from"./vee-validate.esm-df180905.js";const Ie={slot:"headline"},Ee={slot:"content"},Ae={class:"row mb-3"},Ve={class:"col-md-3 col-form-label"},De={class:"col-md-9"},Re=["value"],Me={key:0,class:"input-group mt-2"},qe=["placeholder"],Oe={class:"inner"},Se={class:"help-block"},Ue={value:""},Je=["value"],Le={key:2,class:"invalid-feedback"},je={class:"row mb-3"},Be={class:"col-md-3 col-form-label"},Pe={class:"col-md-9"},He=["value"],Ke={class:"row mb-3"},Qe={class:"col-md-3 col-form-label"},Ye={class:"col-md-9"},Ze={value:"all"},ze=["value"],Ge=["value"],We={class:"row mb-3"},Xe={class:"col-md-3 col-form-label"},xe={class:"col-md-9"},et={slot:"actions"},tt=["disabled"],le=ie({__name:"EditRouteModal",props:{data:{type:Object},devices:{type:Array},networks:{type:Array}},setup(h){var $,B,P,H,K,Q,Y,Z,z;const _=h,{handleSubmit:b}=Ne(),i=ce({if_name:"",apply_to:"all",notes:"",target:"",is_enabled:!0}),p=A(m.INTERNET),D=Object.values(m).filter(s=>[m.IP,m.NET,m.REMOTE_PORT,m.INTERNET].includes(s)),{t:C}=de(),{mutate:R,loading:M,onDone:q}=j({document:S`
