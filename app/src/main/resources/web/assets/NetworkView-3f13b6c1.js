import{_ as k}from"./MonacoEditor.vuevuetypescriptsetuptruelang-8db4cdf0.js";import{_ as y}from"./EditToolbar.vuevuetypescriptsetuptruelang-d3d2e68b.js";import{_ as b}from"./Breadcrumb-56c0fca0.js";import{d as N,u as $,r as m,g as C,x as r,ab as p,bD as c,i as h,c as B,a as D,p as i,j as F,m as d,aW as g,o as S}from"./index-9c78c93b.js";const U={class:"page-container"},q={class:"main"},Q=N({__name:"NetworkView",setup(j){const{t:s}=$(),o=m(0),n=m(""),a=m("");C({handle:(l,e)=>{e?r(s(e),"error"):(n.value=l.networkConfig.netplan,a.value=l.networkConfig.netmix)},document:p`
    query {
      networkConfig {
