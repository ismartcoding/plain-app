import{d as y,u as A,r as C,g as F,x as N,ab as r,c3 as p,R as I,c as o,a as e,p as m,t,F as M,J as q,o as i,l as _,m as v,j as d,Y as h,h as $,Z as f,a2 as D,ac as B,i as E,a5 as T}from"./index-40f25da6.js";import{_ as S}from"./Breadcrumb-5456253f.js";import{E as j}from"./EditValueModal-068407b0.js";import"./vee-validate.esm-7088b7c0.js";const J={class:"page-container"},L={class:"main"},O={class:"table-responsive"},Q={class:"table"},R=e("th",null,"ID",-1),U={class:"actions one"},Y=["onClick"],Z={class:"nowrap"},z={class:"nowrap"},G={class:"actions one"},H=["onClick"],ee=y({__name:"DevicesView",setup(K){const{t:s}=A(),c=C([]);F({handle:(n,l)=>{l?N(s(l),"error"):c.value=[...n.devices]},document:r`
    query {
      devices {
        ...DeviceFragment
      }
