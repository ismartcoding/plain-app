import{d as A,u as y,r as C,i as F,k as N,a8 as r,c2 as p,K as I,e as o,f as e,x as _,t as a,F as M,A as T,o as i,w as m,L as v,h as d,T as h,g as f,U as $,Y as D,a9 as q,a2 as B,a0 as E}from"./index-231cf46a.js";import{_ as L}from"./Breadcrumb-46b04d0b.js";import{E as S}from"./EditValueModal-3caab7f7.js";import"./vee-validate.esm-36a7a1d7.js";const U={class:"page-container"},K={class:"main"},O={class:"table-responsive"},Q={class:"table"},Y=e("th",null,"ID",-1),j={class:"actions one"},z=["onClick"],G={class:"nowrap"},H={class:"nowrap"},J={class:"actions one"},P=["onClick"],ee=A({__name:"DevicesView",setup(R){const{t:s}=y(),c=C([]);F({handle:(n,l)=>{l?N(s(l),"error"):c.value=[...n.devices]},document:r`
    query {
      devices {
        ...DeviceFragment
      }
