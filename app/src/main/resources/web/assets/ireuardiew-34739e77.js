import{_ as I}from"./ieldd-09573248.js";import{_ as y}from"./readcrumb-ccb81e51.js";import{d as D,q as M,r as B,u as F,i as V,t as q,a2 as l,bs as m,Z as E,o as r,c as d,e,f,g as t,F as N,A,j as g,N as S,Q as j,w as $,B as L,a1 as P}from"./inde-e40fd5ce.js";import{p as Q}from"./parser-fdd85e1d.js";import{_ as U}from"./eleteonfirm.vuevuetypescriptsetuptruelang-f10cca05.js";import"./odal.vuevuetypescriptsetuptruelang-c1337498.js";const Z={class:"page-container container"},z={class:"main"},H={class:"table"},J=e("th",null,"ID",-1),K={class:"actions two"},O={class:"form-check"},R=["disabled","onChange","onUpdate:modelValue"],T={class:"actions two"},X=["onClick"],Y=["onClick"],ie=D({__name:"WireGuardView",setup(x){const b=M(),u=B([]),{t:c}=F();function w(n){L(b,`/wireguard/${n}`)}V({handle:(n,s)=>{s?q(c(s),"error"):u.value=n.wireGuards.map(o=>({...o,...Q(o.config)}))},document:l`
    query {
      wireGuards {
        ...WireGuardFragment
      }
