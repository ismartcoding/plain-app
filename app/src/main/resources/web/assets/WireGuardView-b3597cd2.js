import{_ as I}from"./FieldId-7a42c5ae.js";import{_ as y}from"./Breadcrumb-d5bdebe4.js";import{d as D,q as M,r as q,u as B,i as F,t as V,a2 as l,bq as m,Z as E,o as r,c as d,e,f,g as t,F as N,A,j as g,N as S,Q as j,w as $,B as L,a1 as P}from"./index-5f5c60b6.js";import{p as Q}from"./parser-fdd85e1d.js";import{_ as U}from"./DeleteConfirm.vuevuetypescriptsetuptruelang-42857978.js";import"./VModal.vuevuetypescriptsetuptruelang-61cd4dae.js";const Z={class:"page-container container"},z={class:"main"},H={class:"table"},J=e("th",null,"ID",-1),K={class:"actions two"},O={class:"form-check"},R=["disabled","onChange","onUpdate:modelValue"],T={class:"actions two"},X=["onClick"],Y=["onClick"],ie=D({__name:"WireGuardView",setup(x){const b=M(),u=q([]),{t:c}=B();function w(n){L(b,`/wireguard/${n}`)}F({handle:(n,s)=>{s?V(c(s),"error"):u.value=n.wireGuards.map(o=>({...o,...Q(o.config)}))},document:l`
    query {
      wireGuards {
        ...WireGuardFragment
      }
