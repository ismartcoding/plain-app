import{d as le,K as ce,r as N,u as se,i as B,aq as O,b_ as F,b$ as re,g as ue,O as pe,ao as T,o as r,c as u,a as e,t as o,k as c,m as _,c0 as V,c1 as R,F as w,J as C,v as X,n as Y,p as A,H as x,l as J,at as me,h as _e,x as ve,ac as L,c2 as fe,c3 as he,S as ge,a3 as j,Z as ee,j as te,$ as oe,w as ne,ad as $e,a6 as be}from"./index-53a7b7bf.js";import{_ as ke}from"./Breadcrumb-ae8ab346.js";import{T as $,a as b,_ as ye,A as we}from"./question-mark-rounded-d1ec4a35.js";import{u as Ce,a as Fe}from"./vee-validate.esm-18d571e0.js";const Te={slot:"headline"},Ve={slot:"content"},Ne={class:"row"},Ae={class:"col-md-3 col-form-label"},De={class:"col-md-9 form-checks"},Ie={class:"form-check form-check-inline"},Me={class:"form-check-label",for:"action-allow"},Se={class:"form-check form-check-inline"},qe={class:"form-check-label",for:"action-block"},Ee={class:"row mb-2"},Ue={for:"action",class:"col-md-3 col-form-label"},Oe={class:"col-md-9 form-checks"},Re={class:"form-check form-check-inline"},Je={class:"form-check-label",for:"direction-inbound"},Le={class:"form-check form-check-inline"},je={class:"form-check-label",for:"direction-outbound"},Be={class:"row mb-3"},Qe={class:"col-md-3 col-form-label"},Ge={class:"col-md-9"},He=["value"],Ke={key:0,class:"input-group mt-2"},Ze=["placeholder"],ze={class:"inner"},Pe={class:"help-block"},We={value:""},Xe=["value"],Ye={key:2,class:"invalid-feedback"},xe={class:"row mb-3"},et={class:"col-md-3 col-form-label"},tt={class:"col-md-9"},ot={value:"all"},nt=["value"],at=["value"],lt={class:"row mb-3"},st={class:"col-md-3 col-form-label"},it={class:"col-md-9"},dt={slot:"actions"},ct=["disabled"],ae=le({__name:"EditRuleModal",props:{data:{type:Object},devices:{type:Array},networks:{type:Array}},setup(k){var y,Q,G,H,K,Z,z;const f=k,{handleSubmit:g}=Ce(),l=ce({action:"block",direction:"inbound",protocol:"all",apply_to:"all",notes:"",target:"",is_enabled:!0}),p=N($.DNS),D=Object.values($),{t:I}=se(),{mutate:M,loading:S,onDone:q}=B({document:O`
    ...
    ${F}
  `,options:{update:(n,s)=>{re(n,s.data.createConfig,O`
          query {
            configs {
              ...ConfigFragment
            }
          ...
          ${F}
        `)}}}),{mutate:E,loading:U,onDone:a}=B({document:O`
...
`;function I(a){j($e,{id:a.id,name:a.id,gql:D,appApi:!1,typeName:"Config"})}function M(a){j(ae,{data:a,devices:g,networks:l})}function S(){j(ae,{data:null,devices:g,networks:l})}const{mutate:q,loading:E}=B({document:L`
    mutation updateConfig($id: ID!, $input: ConfigInput!) {
      updateConfig(id: $id, input: $input) {
        ...ConfigFragment
      }
