import{_ as x}from"./MonacoEditor.vuevuetypescriptsetuptruelang-396b6648.js";import{_ as y}from"./EditToolbar.vuevuetypescriptsetuptruelang-afdb2d27.js";import{_ as N}from"./Breadcrumb-99ff7c19.js";import{d as $,u as b,r as s,i as C,t as r,a2 as p,bp as c,Z as h,o as B,c as F,e as S,f as i,j as U,N as d,ae as g}from"./index-cf22a9d8.js";const q={class:"page-container container"},D={class:"main"},Q=$({__name:"NetworkView",setup(j){const{t:u}=b(),o=s(0),n=s(""),t=s("");C({handle:(l,e)=>{e?r(u(e),"error"):(n.value=l.networkConfig.netplan,t.value=l.networkConfig.netmix)},document:p`
    query {
      networkConfig {
