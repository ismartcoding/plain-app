import{d as I,a as y,r as D,u as F,i as M,k as B,a7 as o,bw as g,a1 as q,e as l,f as e,x as $,t,F as A,A as E,o as r,h as f,w as m,n as N,X as S,a8 as V,$ as L}from"./index-0e0a27ad.js";import{_ as P}from"./Breadcrumb-094dc27c.js";import{p as j}from"./parser-fdd85e1d.js";const Q={class:"page-container"},X={class:"main"},z={class:"table-responsive"},H={class:"table"},J=e("th",null,"ID",-1),K={class:"actions two"},O={class:"form-check"},R=["disabled","onChange","checked"],T={class:"actions two"},U=["onClick"],Y=["onClick"],ae=I({__name:"WireGuardView",setup(Z){const b=y(),d=D([]),{t:c}=F();function w(n){N(b,`/wireguard/${n}`)}M({handle:(n,s)=>{s?B(c(s),"error"):d.value=n.wireGuards.map(i=>({...i,...j(i.config)}))},document:o`
    query {
      wireGuards {
        ...WireGuardFragment
      }
