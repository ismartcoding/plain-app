import{_ as w}from"./FieldId-439f3700.js";import{_ as b}from"./Breadcrumb-7c24ea6b.js";import{d as y,u as A,r as C,i as F,t as V,Y as i,bp as u,o as r,c as d,b as e,e as m,f as a,F as I,y as N,w as p,g as l,O as _,P as f,X as h,U as q}from"./index-400f4a7b.js";import{_ as B}from"./DeleteConfirm.vuevuetypescriptsetuptruelang-b4ebfb77.js";import{_ as M}from"./EditValueModal.vuevuetypescriptsetuptruelang-ccce301d.js";import"./VModal.vuevuetypescriptsetuptruelang-610de861.js";import"./vee-validate.esm-5d9cc34a.js";const O={class:"page-container container"},S={class:"main"},T={class:"table"},U=e("th",null,"ID",-1),E={class:"actions one"},L=["onClick"],P=["title"],Q=["title"],X={class:"actions one"},Y=["onClick"],Z=y({__name:"DevicesView",setup(j){const{t:s}=A(),c=C([]);F({handle:(n,o)=>{o?V(s(o),"error"):c.value=[...n.devices]},document:i`
    query {
      devices {
        ...DeviceFragment
      }
