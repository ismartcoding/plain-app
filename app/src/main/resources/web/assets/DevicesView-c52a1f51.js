import{d as A,u as y,r as C,i as F,t as N,a6 as r,c6 as p,L as I,o as l,e as i,f as e,x as _,j as a,F as M,A as q,w as m,M as v,k as d,P as h,g as $,Q as f,V as D,a7 as B,a2 as E,Y as T}from"./index-5e3ce573.js";import{_ as L}from"./Breadcrumb-db3f2c63.js";import{E as Q}from"./EditValueModal-e04a5760.js";import"./vee-validate.esm-e8a787ff.js";const S={class:"page-container"},j={class:"main"},O={class:"table-responsive"},P={class:"table"},U=e("th",null,"ID",-1),Y={class:"actions one"},z=["onClick"],G={class:"nowrap"},H={class:"nowrap"},J={class:"actions one"},K=["onClick"],ee=A({__name:"DevicesView",setup(R){const{t:s}=y(),c=C([]);F({handle:(n,o)=>{o?N(s(o),"error"):c.value=[...n.devices]},document:r`
    query {
      devices {
        ...DeviceFragment
      }
