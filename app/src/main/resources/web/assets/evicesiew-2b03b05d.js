import{_ as w}from"./ieldd-09573248.js";import{_ as b}from"./readcrumb-ccb81e51.js";import{d as A,u as y,r as C,i as F,t as V,a2 as i,bZ as u,o as r,c as d,e,f as m,g as a,F as I,A as N,w as p,j as l,S as _,T as f,a1 as h,Z as q}from"./inde-e40fd5ce.js";import{_ as B}from"./eleteonfirm.vuevuetypescriptsetuptruelang-f10cca05.js";import{_ as M}from"./ditalueodal.vuevuetypescriptsetuptruelang-41de1b05.js";import"./odal.vuevuetypescriptsetuptruelang-c1337498.js";import"./vee-validate.esm-30412532.js";const S={class:"page-container container"},T={class:"main"},Z={class:"table"},j=e("th",null,"ID",-1),E={class:"actions one"},L=["onClick"],O=["title"],Q=["title"],U={class:"actions one"},z=["onClick"],Y=A({__name:"DevicesView",setup(G){const{t:s}=y(),c=C([]);F({handle:(n,o)=>{o?V(s(o),"error"):c.value=[...n.devices]},document:i`
    query {
      devices {
        ...DeviceFragment
      }
