import{_ as x}from"./MonacoEditor.vuevuetypescriptsetuptruelang-dd26fbfc.js";import{_ as y}from"./EditToolbar.vuevuetypescriptsetuptruelang-393ee7f4.js";import{_ as b}from"./Breadcrumb-bd8351db.js";import{d as N,u as $,r as s,i as C,t as r,Z as p,bg as c,V as h,o as B,c as F,b as S,e as i,g as U,K as d,a6 as g}from"./index-ab4e24e3.js";const q={class:"page-container container"},D={class:"main"},Q=N({__name:"NetworkView",setup(A){const{t:u}=$(),o=s(0),n=s(""),t=s("");C({handle:(l,e)=>{e?r(u(e),"error"):(n.value=l.networkConfig.netplan,t.value=l.networkConfig.netmix)},document:p`
    query {
      networkConfig {
