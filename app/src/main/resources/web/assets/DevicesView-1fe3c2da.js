import{_ as w}from"./FieldId-611b5383.js";import{_ as b}from"./Breadcrumb-d14ac849.js";import{d as V,u as y,r as A,i as C,t as F,Z as i,bV as u,o as r,c as d,b as e,e as m,f as a,F as I,y as N,w as p,g as l,P as _,Q as f,Y as h,V as q}from"./index-8742030b.js";import{_ as B}from"./DeleteConfirm.vuevuetypescriptsetuptruelang-3e1c6dd0.js";import{_ as M}from"./EditValueModal.vuevuetypescriptsetuptruelang-3f3aa0f8.js";import"./VModal.vuevuetypescriptsetuptruelang-fff027ba.js";import"./vee-validate.esm-5b728b5f.js";const Q={class:"page-container container"},S={class:"main"},T={class:"table"},E=e("th",null,"ID",-1),L={class:"actions one"},O=["onClick"],P=["title"],U=["title"],Y={class:"actions one"},Z=["onClick"],X=V({__name:"DevicesView",setup(j){const{t:s}=y(),c=A([]);C({handle:(n,o)=>{o?F(s(o),"error"):c.value=[...n.devices]},document:i`
    query {
      devices {
        ...DeviceFragment
      }
