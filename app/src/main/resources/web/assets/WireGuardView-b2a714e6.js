import{d as I,e as y,r as D,u as F,g as M,x as B,ab as o,b_ as g,i as q,c as l,a as e,p as $,t,F as E,J as N,o as r,j as f,l as m,C as S,a2 as V,ac as j,a5 as A}from"./index-6a499fad.js";import{_ as L}from"./Breadcrumb-f5c8c905.js";import{p as P}from"./parser-fdd85e1d.js";const J={class:"page-container"},Q={class:"main"},z={class:"table-responsive"},H={class:"table"},K=e("th",null,"ID",-1),O={class:"actions two"},R={class:"form-check"},T=["disabled","onChange","checked"],U={class:"actions two"},X=["onClick"],Y=["onClick"],ae=I({__name:"WireGuardView",setup(Z){const b=y(),d=D([]),{t:c}=F();function v(n){S(b,`/wireguard/${n}`)}M({handle:(n,s)=>{s?B(c(s),"error"):d.value=n.wireGuards.map(i=>({...i,...P(i.config)}))},document:o`
    query {
      wireGuards {
        ...WireGuardFragment
      }
