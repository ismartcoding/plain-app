import{_ as k}from"./MonacoEditor.vuevuetypescriptsetuptruelang-BFVbtP9H.js";import{_ as y}from"./EditToolbar.vuevuetypescriptsetuptruelang-CixbO2wa.js";import{_ as $}from"./Breadcrumb-7GnPZCg_.js";import{d as C,g as N,h as u,l as b,C as s,ac as p,b$ as g,j as F,c as h,p as m,m as S,x as c,aL as d,O as U,o as q}from"./index-BXOWKrmL.js";const I=C({__name:"NetworkView",setup(B){const{t:i}=N(),o=u(0),n=u(""),t=u("");b({handle:(l,e)=>{e?s(i(e),"error"):(n.value=l.networkConfig.netplan,t.value=l.networkConfig.netmix)},document:p`
    query {
      networkConfig {
