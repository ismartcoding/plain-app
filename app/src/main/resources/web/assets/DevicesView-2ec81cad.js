import{_ as w}from"./FieldId-157cea66.js";import{_ as b}from"./Breadcrumb-21545a73.js";import{d as V,u as y,r as A,i as C,t as F,Z as i,bV as u,o as r,c as d,b as e,e as m,f as a,F as I,y as N,w as p,g as l,P as _,Q as f,Y as h,V as q}from"./index-969024c8.js";import{_ as B}from"./DeleteConfirm.vuevuetypescriptsetuptruelang-8440e164.js";import{_ as M}from"./EditValueModal.vuevuetypescriptsetuptruelang-7059a330.js";import"./VModal.vuevuetypescriptsetuptruelang-34936a76.js";import"./vee-validate.esm-fbca28e1.js";const Q={class:"page-container container"},S={class:"main"},T={class:"table"},E=e("th",null,"ID",-1),L={class:"actions one"},O=["onClick"],P=["title"],U=["title"],Y={class:"actions one"},Z=["onClick"],X=V({__name:"DevicesView",setup(j){const{t:s}=y(),c=A([]);C({handle:(n,o)=>{o?F(s(o),"error"):c.value=[...n.devices]},document:i`
    query {
      devices {
        ...DeviceFragment
      }
