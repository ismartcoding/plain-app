import{_ as w}from"./FieldId-a6855e87.js";import{_ as b}from"./Breadcrumb-f25190bb.js";import{d as y,u as A,r as C,i as F,t as V,Y as i,bU as u,o as r,c as d,b as e,e as m,f as a,F as I,y as N,w as p,g as l,O as _,P as f,X as h,U as q}from"./index-b61558b0.js";import{_ as B}from"./DeleteConfirm.vuevuetypescriptsetuptruelang-10c33046.js";import{_ as M}from"./EditValueModal.vuevuetypescriptsetuptruelang-c69213ac.js";import"./VModal.vuevuetypescriptsetuptruelang-97be675f.js";import"./vee-validate.esm-3e89ad50.js";const U={class:"page-container container"},O={class:"main"},S={class:"table"},T=e("th",null,"ID",-1),E={class:"actions one"},L=["onClick"],P=["title"],Q=["title"],X={class:"actions one"},Y=["onClick"],Z=y({__name:"DevicesView",setup(j){const{t:s}=A(),c=C([]);F({handle:(n,o)=>{o?V(s(o),"error"):c.value=[...n.devices]},document:i`
    query {
      devices {
        ...DeviceFragment
      }
