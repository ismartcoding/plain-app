import{_ as k}from"./MonacoEditor.vuevuetypescriptsetuptruelang-9878e618.js";import{_ as y}from"./EditToolbar.vuevuetypescriptsetuptruelang-e65448c1.js";import{_ as b}from"./Breadcrumb-66ab2aa6.js";import{d as N,u as $,r as m,g as C,x as r,ab as p,bD as c,i as h,c as B,a as D,p as i,j as F,m as d,aW as g,o as S}from"./index-e3113b21.js";const U={class:"page-container"},q={class:"main"},Q=N({__name:"NetworkView",setup(j){const{t:s}=$(),o=m(0),n=m(""),a=m("");C({handle:(l,e)=>{e?r(s(e),"error"):(n.value=l.networkConfig.netplan,a.value=l.networkConfig.netmix)},document:p`
    query {
      networkConfig {
