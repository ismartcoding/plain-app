import{_ as y}from"./FieldId-d3cd765c.js";import{_ as I}from"./Breadcrumb-49d3fe3b.js";import{d as M,p as D,r as F,u as V,i as B,t as E,Y as l,bk as m,U as q,o as r,c as d,b as e,e as f,f as t,F as N,y as S,g,J as U,M as A,w as $,z as L,X as P}from"./index-03d179e2.js";import{p as j}from"./parser-fdd85e1d.js";import{_ as z}from"./DeleteConfirm.vuevuetypescriptsetuptruelang-3b6b8b22.js";import"./VModal.vuevuetypescriptsetuptruelang-33c2fc8e.js";const J={class:"page-container container"},Q={class:"main"},X={class:"table"},Y=e("th",null,"ID",-1),H={class:"actions two"},K={class:"form-check"},O=["disabled","onChange","onUpdate:modelValue"],R={class:"actions two"},T=["onClick"],Z=["onClick"],ie=M({__name:"WireGuardView",setup(x){const b=D(),u=F([]),{t:c}=V();function w(n){L(b,`/wireguard/${n}`)}B({handle:(n,s)=>{s?E(c(s),"error"):u.value=n.wireGuards.map(o=>({...o,...j(o.config)}))},document:l`
    query {
      wireGuards {
        ...WireGuardFragment
      }
