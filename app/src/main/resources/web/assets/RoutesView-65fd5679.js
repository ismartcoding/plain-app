import{_ as ce}from"./FieldId-a1c873ab.js";import{_ as pe}from"./Breadcrumb-6debfc1a.js";import{d as le,A as _e,r as E,u as ie,U as L,a3 as U,bm as T,bn as me,a0 as fe,G as ve,a1 as x,o as c,Q as ge,v as I,b as e,f as a,J as $,c as p,F as y,y as k,g as l,a5 as A,N as ee,K as te,e as V,k as S,a7 as $e,i as he,t as be,Y as J,bp as ye,bq as ke,M as we,O as ae,P as oe,w as ne,X as B}from"./index-4e7fbfe1.js";import{T as f,a as w,_ as Ce,A as Ne}from"./question-mark-rounded-5810288a.js";import{_ as Te}from"./DeleteConfirm.vuevuetypescriptsetuptruelang-2717b911.js";import{_ as Fe}from"./VModal.vuevuetypescriptsetuptruelang-fe406bcd.js";import{u as Ie,a as Ae}from"./vee-validate.esm-a962d6bf.js";import"./stringToArray-eaf16b6f.js";import"./baseIndexOf-70b929c6.js";const Ee={class:"row mb-3"},Ve={class:"col-md-3 col-form-label"},De={class:"col-md-9"},Me=["value"],Re={key:0,class:"input-group mt-2"},qe=["placeholder"],Oe={class:"inner"},Ue={class:"help-block"},Se={value:""},Je=["value"],Be={key:2,class:"invalid-feedback"},Le={class:"row mb-3"},Pe={class:"col-md-3 col-form-label"},je={class:"col-md-9"},Qe=["value"],Ge={class:"row mb-3"},Ke={class:"col-md-3 col-form-label"},Xe={class:"col-md-9"},Ye={value:"all"},ze=["value"],He=["value"],We={class:"row mb-3"},Ze={class:"col-md-3 col-form-label"},xe={class:"col-md-9"},et=["disabled"],se=le({__name:"EditRouteModal",props:{data:{type:Object},devices:{type:Array},networks:{type:Array}},setup(h){var P,j,Q,G,K,X,Y,z,H;const m=h,{handleSubmit:b}=Ie(),i=_e({if_name:"",apply_to:"all",notes:"",target:"",is_enabled:!0}),_=E(f.INTERNET),D=Object.values(f).filter(n=>[f.IP,f.NET,f.REMOTE_PORT,f.INTERNET].includes(n)),{t:C}=ie(),{mutate:M,loading:R,onDone:q}=L({document:U`
    ...
    ${T}
  `,options:{update:(n,r)=>{me(n,r.data.createConfig,U`
          query {
            configs {
              ...ConfigFragment
            }
          ...
          ${T}
        `)}}}),{mutate:O,loading:o,onDone:N}=L({document:U`
  ...
  `});function D(o){B(Te,{id:o.id,name:o.id,gql:J`
    ...
    `,appApi:!1,typeName:"Config"})}function C(o){B(se,{data:o,devices:b,networks:i})}function M(){B(se,{data:null,devices:b,networks:i})}const{mutate:R,loading:q}=L({document:J`
    mutation updateConfig($id: ID!, $input: ConfigInput!) {
      updateConfig(id: $id, input: $input) {
        ...ConfigFragment
      }
