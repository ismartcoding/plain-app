import{_ as x}from"./MonacoEditor.vuevuetypescriptsetuptruelang-1c175a51.js";import{_ as y}from"./EditToolbar.vuevuetypescriptsetuptruelang-d383a142.js";import{_ as b}from"./Breadcrumb-ace66a87.js";import{d as N,u as $,r as u,i as C,k as r,a7 as p,bu as d,a1 as h,e as B,f as F,x as i,h as S,K as c,bv as g,o as U}from"./index-642041e3.js";const q={class:"page-container"},D={class:"main"},Q=N({__name:"NetworkView",setup(A){const{t:s}=$(),o=u(0),n=u(""),t=u("");C({handle:(l,e)=>{e?r(s(e),"error"):(n.value=l.networkConfig.netplan,t.value=l.networkConfig.netmix)},document:p`
    query {
      networkConfig {
