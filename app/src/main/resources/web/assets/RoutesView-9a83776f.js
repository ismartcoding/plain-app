import{d as ie,B as ce,r as E,u as de,a1 as B,am as S,bY as F,bZ as pe,ai as _e,G as me,aj as I,o as u,e as r,f as e,t as o,h as l,K as f,b$ as A,F as y,A as k,Q as x,ak as ee,x as V,y as te,j as U,ap as ve,i as fe,k as ge,a7 as J,c0 as $e,c1 as he,J as be,W as j,S as ae,g as oe,T as ne,w as se,a8 as ye,$ as ke}from"./index-642041e3.js";import{_ as we}from"./Breadcrumb-ace66a87.js";import{T as m,a as w,_ as Ce,A as Te}from"./question-mark-rounded-a9725222.js";import{u as Ne,a as Fe}from"./vee-validate.esm-805f179c.js";const Ie={slot:"headline"},Ae={slot:"content"},Ee={class:"row mb-3"},Ve={class:"col-md-3 col-form-label"},De={class:"col-md-9"},Re=["value"],Me={key:0,class:"input-group mt-2"},qe=["placeholder"],Oe={class:"inner"},Se={class:"help-block"},Ue={value:""},Je=["value"],je={key:2,class:"invalid-feedback"},Be={class:"row mb-3"},Le={class:"col-md-3 col-form-label"},Pe={class:"col-md-9"},Qe=["value"],Ge={class:"row mb-3"},Ke={class:"col-md-3 col-form-label"},We={class:"col-md-9"},Ye={value:"all"},Ze=["value"],ze=["value"],He={class:"row mb-3"},Xe={class:"col-md-3 col-form-label"},xe={class:"col-md-9"},et={slot:"actions"},tt=["disabled"],le=ie({__name:"EditRouteModal",props:{data:{type:Object},devices:{type:Array},networks:{type:Array}},setup(h){var $,L,P,Q,G,K,W,Y,Z;const _=h,{handleSubmit:b}=Ne(),i=ce({if_name:"",apply_to:"all",notes:"",target:"",is_enabled:!0}),p=E(m.INTERNET),D=Object.values(m).filter(s=>[m.IP,m.NET,m.REMOTE_PORT,m.INTERNET].includes(s)),{t:C}=de(),{mutate:R,loading:M,onDone:q}=B({document:S`
