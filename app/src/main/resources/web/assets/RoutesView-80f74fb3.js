import{_ as ce}from"./FieldId-7f31c269.js";import{_ as pe}from"./Breadcrumb-a2d00dde.js";import{d as le,A as _e,r as E,u as ie,U as L,a3 as q,bR as T,bS as me,a0 as fe,G as ve,a1 as x,o as c,Q as ge,v as I,b as e,f as a,J as $,c as p,F as y,y as k,g as l,a5 as A,N as ee,K as te,e as V,k as S,a7 as $e,i as he,t as be,Y as J,bU as ye,bV as ke,M as we,O as ae,P as oe,w as ne,X as B}from"./index-bf00d94e.js";import{T as f,a as w,_ as Ce,A as Ne}from"./question-mark-rounded-df6b8f4c.js";import{_ as Te}from"./DeleteConfirm.vuevuetypescriptsetuptruelang-aece5a82.js";import{_ as Fe}from"./VModal.vuevuetypescriptsetuptruelang-31725e85.js";import{u as Ie,a as Ae}from"./vee-validate.esm-4409073a.js";import"./stringToArray-11593afd.js";import"./baseIndexOf-70b929c6.js";const Ee={class:"row mb-3"},Ve={class:"col-md-3 col-form-label"},De={class:"col-md-9"},Me=["value"],Re={key:0,class:"input-group mt-2"},Ue=["placeholder"],Oe={class:"inner"},qe={class:"help-block"},Se={value:""},Je=["value"],Be={key:2,class:"invalid-feedback"},Le={class:"row mb-3"},Pe={class:"col-md-3 col-form-label"},je={class:"col-md-9"},Qe=["value"],Ge={class:"row mb-3"},Ke={class:"col-md-3 col-form-label"},Xe={class:"col-md-9"},Ye={value:"all"},ze=["value"],He=["value"],We={class:"row mb-3"},Ze={class:"col-md-3 col-form-label"},xe={class:"col-md-9"},et=["disabled"],se=le({__name:"EditRouteModal",props:{data:{type:Object},devices:{type:Array},networks:{type:Array}},setup(h){var P,j,Q,G,K,X,Y,z,H;const m=h,{handleSubmit:b}=Ie(),i=_e({if_name:"",apply_to:"all",notes:"",target:"",is_enabled:!0}),_=E(f.INTERNET),D=Object.values(f).filter(n=>[f.IP,f.NET,f.REMOTE_PORT,f.INTERNET].includes(n)),{t:C}=ie(),{mutate:M,loading:R,onDone:U}=L({document:q`
  ...
  `,options:{update:(n,r)=>{me(n,r.data.createConfig,q`
          ...
          ${T}
        `)}}}),{mutate:O,loading:o,onDone:N}=L({document:q`
