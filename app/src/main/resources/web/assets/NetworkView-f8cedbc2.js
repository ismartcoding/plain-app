import{_ as x}from"./MonacoEditor.vuevuetypescriptsetuptruelang-c1ef1d82.js";import{_ as y}from"./EditToolbar.vuevuetypescriptsetuptruelang-994cdafc.js";import{_ as N}from"./Breadcrumb-d9676db0.js";import{d as $,u as b,r as m,h as C,x as r,ac as p,by as c,i as h,c as B,a as F,p as i,k as S,m as d,aV as g,o as U}from"./index-e900249a.js";const q={class:"page-container"},D={class:"main"},T=$({__name:"NetworkView",setup(A){const{t:s}=b(),o=m(0),n=m(""),a=m("");C({handle:(l,e)=>{e?r(s(e),"error"):(n.value=l.networkConfig.netplan,a.value=l.networkConfig.netmix)},document:p`
    query {
      networkConfig {
