import{_ as y}from"./FieldId-a909509e.js";import{_ as I}from"./Breadcrumb-cc2ecefa.js";import{d as D,p as M,r as V,u as F,i as B,t as E,Z as l,bj as m,V as N,o as r,c as d,b as e,e as f,f as t,F as q,y as S,g,K as j,N as A,w as $,z as L,Y as P}from"./index-5f2856f5.js";import{p as U}from"./parser-fdd85e1d.js";import{_ as z}from"./DeleteConfirm.vuevuetypescriptsetuptruelang-3041997c.js";import"./VModal.vuevuetypescriptsetuptruelang-1b277c9f.js";const K={class:"page-container container"},Q={class:"main"},Y={class:"table"},Z=e("th",null,"ID",-1),H={class:"actions two"},J={class:"form-check"},O=["disabled","onChange","onUpdate:modelValue"],R={class:"actions two"},T=["onClick"],X=["onClick"],ie=D({__name:"WireGuardView",setup(x){const b=M(),u=V([]),{t:c}=F();function w(n){L(b,`/wireguard/${n}`)}B({handle:(n,s)=>{s?E(c(s),"error"):u.value=n.wireGuards.map(o=>({...o,...U(o.config)}))},document:l`
    query {
      wireGuards {
        ...WireGuardFragment
      }
