import{d as I,e as y,r as D,u as F,h as M,x as B,ac as o,bZ as g,i as q,c as l,a as e,p as $,t,F as E,J as N,o as r,k as f,w as m,C as S,a3 as V,ad as A,a6 as L}from"./index-6ca6ab55.js";import{_ as P}from"./Breadcrumb-1bb571cf.js";import{p as j}from"./parser-fdd85e1d.js";const J={class:"page-container"},Q={class:"main"},Z={class:"table-responsive"},z={class:"table"},H=e("th",null,"ID",-1),K={class:"actions two"},O={class:"form-check"},R=["disabled","onChange","checked"],T={class:"actions two"},U=["onClick"],X=["onClick"],ae=I({__name:"WireGuardView",setup(Y){const b=y(),d=D([]),{t:c}=F();function w(n){S(b,`/wireguard/${n}`)}M({handle:(n,s)=>{s?B(c(s),"error"):d.value=n.wireGuards.map(i=>({...i,...j(i.config)}))},document:o`
    query {
      wireGuards {
        ...WireGuardFragment
      }
