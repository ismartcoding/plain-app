import{_ as x}from"./MonacoEditor.vuevuetypescriptsetuptruelang-1f3473c2.js";import{_ as y}from"./EditToolbar.vuevuetypescriptsetuptruelang-c5f6cd53.js";import{_ as b}from"./Breadcrumb-7351818d.js";import{d as N,u as $,r as s,i as C,t as r,Z as p,bg as c,V as h,o as B,c as F,b as S,e as i,g as U,K as d,a6 as g}from"./index-2128710d.js";const q={class:"page-container container"},D={class:"main"},Q=N({__name:"NetworkView",setup(A){const{t:u}=$(),o=s(0),n=s(""),t=s("");C({handle:(l,e)=>{e?r(u(e),"error"):(n.value=l.networkConfig.netplan,t.value=l.networkConfig.netmix)},document:p`
    query {
      networkConfig {
