import{d as A,u as y,r as C,i as F,k as N,a7 as r,b$ as p,K as I,e as o,f as e,x as _,t as a,F as M,A as T,o as i,w as m,L as v,h as d,T as h,g as $,U as f,X as D,a8 as q,a1 as B,$ as E}from"./index-bfd324f1.js";import{_ as L}from"./Breadcrumb-d5b3180f.js";import{E as S}from"./EditValueModal-289a29d7.js";import"./vee-validate.esm-4679beb0.js";const U={class:"page-container"},K={class:"main"},O={class:"table-responsive"},Q={class:"table"},X=e("th",null,"ID",-1),j={class:"actions one"},z=["onClick"],G={class:"nowrap"},H={class:"nowrap"},J={class:"actions one"},P=["onClick"],ee=A({__name:"DevicesView",setup(R){const{t:s}=y(),c=C([]);F({handle:(n,l)=>{l?N(s(l),"error"):c.value=[...n.devices]},document:r`
    query {
      devices {
        ...DeviceFragment
      }
