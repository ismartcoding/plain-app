import{_ as x}from"./MonacoEditor.vuevuetypescriptsetuptruelang-ede0c85d.js";import{_ as y}from"./EditToolbar.vuevuetypescriptsetuptruelang-56eb72a4.js";import{_ as b}from"./Breadcrumb-a2d00dde.js";import{d as N,u as $,r as s,i as C,t as r,Y as p,bf as c,U as h,o as U,c as B,b as F,e as i,g as S,J as d,a2 as g}from"./index-bf00d94e.js";const q={class:"page-container container"},D={class:"main"},Q=N({__name:"NetworkView",setup(A){const{t:u}=$(),o=s(0),n=s(""),t=s("");C({handle:(l,e)=>{e?r(u(e),"error"):(n.value=l.networkConfig.netplan,t.value=l.networkConfig.netmix)},document:p`
    query {
      networkConfig {
