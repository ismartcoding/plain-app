import{d as I,a as y,r as D,u as F,i as M,t as B,a6 as i,bC as g,a2 as V,o as l,e as r,f as e,x as $,j as t,F as q,A,k as f,w as m,n as E,V as N,a7 as S,Y as j}from"./index-5e3ce573.js";import{_ as L}from"./Breadcrumb-db3f2c63.js";import{p as P}from"./parser-fdd85e1d.js";const Q={class:"page-container"},Y={class:"main"},z={class:"table-responsive"},H={class:"table"},J=e("th",null,"ID",-1),K={class:"actions two"},O={class:"form-check"},R=["disabled","onChange","checked"],T={class:"actions two"},U=["onClick"],X=["onClick"],ae=I({__name:"WireGuardView",setup(Z){const b=y(),d=D([]),{t:u}=F();function w(n){E(b,`/wireguard/${n}`)}M({handle:(n,s)=>{s?B(u(s),"error"):d.value=n.wireGuards.map(o=>({...o,...P(o.config)}))},document:i`
    query {
      wireGuards {
        ...WireGuardFragment
      }
