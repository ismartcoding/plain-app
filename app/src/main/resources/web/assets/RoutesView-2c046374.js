import{d as ie,B as ce,r as E,u as de,a2 as B,al as S,c2 as I,c3 as pe,ah as _e,I as me,ai as F,o as u,e as r,f as e,j as o,k as l,M as f,c5 as A,F as b,A as k,N as x,aj as ee,x as V,y as te,m as U,ao as ve,i as fe,t as ge,a6 as L,c6 as $e,c7 as he,L as ye,P as ae,g as oe,Q as ne,w as se,V as j,a7 as be,Y as ke}from"./index-5e3ce573.js";import{_ as we}from"./Breadcrumb-db3f2c63.js";import{T as m,a as w,_ as Ce,A as Ne}from"./question-mark-rounded-3ada7d92.js";import{u as Te,a as Ie}from"./vee-validate.esm-e8a787ff.js";import"./stringToArray-ca618d4a.js";const Fe={slot:"headline"},Ae={slot:"content"},Ee={class:"row mb-3"},Ve={class:"col-md-3 col-form-label"},De={class:"col-md-9"},Me=["value"],Re={key:0,class:"input-group mt-2"},qe=["placeholder"],Oe={class:"inner"},Se={class:"help-block"},Ue={value:""},Le=["value"],je={key:2,class:"invalid-feedback"},Be={class:"row mb-3"},Je={class:"col-md-3 col-form-label"},Pe={class:"col-md-9"},Qe=["value"],Ye={class:"row mb-3"},ze={class:"col-md-3 col-form-label"},Ge={class:"col-md-9"},He={value:"all"},Ke=["value"],We=["value"],Xe={class:"row mb-3"},Ze={class:"col-md-3 col-form-label"},xe={class:"col-md-9"},et={slot:"actions"},tt=["disabled"],le=ie({__name:"EditRouteModal",props:{data:{type:Object},devices:{type:Array},networks:{type:Array}},setup(h){var $,J,P,Q,Y,z,G,H,K;const _=h,{handleSubmit:y}=Te(),i=ce({if_name:"",apply_to:"all",notes:"",target:"",is_enabled:!0}),p=E(m.INTERNET),D=Object.values(m).filter(s=>[m.IP,m.NET,m.REMOTE_PORT,m.INTERNET].includes(s)),{t:C}=de(),{mutate:M,loading:R,onDone:q}=B({document:S`
