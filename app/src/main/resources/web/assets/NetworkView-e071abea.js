import{_ as x}from"./MonacoEditor.vuevuetypescriptsetuptruelang-0eaef0f5.js";import{_ as y}from"./EditToolbar.vuevuetypescriptsetuptruelang-147cdb5b.js";import{_ as b}from"./Breadcrumb-db3f2c63.js";import{d as N,u as $,r as s,i as C,t as r,a6 as p,by as d,a2 as h,o as B,e as F,f as S,x as i,k as U,M as c,bz as g}from"./index-5e3ce573.js";const q={class:"page-container"},D={class:"main"},Q=N({__name:"NetworkView",setup(M){const{t:u}=$(),o=s(0),n=s(""),t=s("");C({handle:(l,e)=>{e?r(u(e),"error"):(n.value=l.networkConfig.netplan,t.value=l.networkConfig.netmix)},document:p`
    query {
      networkConfig {
