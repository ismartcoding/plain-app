import{_ as x}from"./MonacoEditor.vuevuetypescriptsetuptruelang-ab15f748.js";import{_ as y}from"./EditToolbar.vuevuetypescriptsetuptruelang-f05130b4.js";import{_ as N}from"./Breadcrumb-46b04d0b.js";import{d as $,u as b,r as s,i as C,k as r,a8 as p,by as d,a2 as h,e as B,f as F,x as i,h as S,L as c,aV as g,o as U}from"./index-231cf46a.js";const q={class:"page-container"},D={class:"main"},Q=$({__name:"NetworkView",setup(A){const{t:u}=b(),o=s(0),n=s(""),a=s("");C({handle:(l,e)=>{e?r(u(e),"error"):(n.value=l.networkConfig.netplan,a.value=l.networkConfig.netmix)},document:p`
    query {
      networkConfig {
