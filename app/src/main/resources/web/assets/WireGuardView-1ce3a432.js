import{d as I,a as y,r as D,u as F,i as M,k as B,a7 as o,by as g,a1 as q,e as l,f as e,x as $,t,F as A,A as E,o as r,h as f,w as m,n as N,W as S,a8 as V,$ as L}from"./index-642041e3.js";import{_ as P}from"./Breadcrumb-ace66a87.js";import{p as j}from"./parser-fdd85e1d.js";const Q={class:"page-container"},z={class:"main"},H={class:"table-responsive"},J={class:"table"},K=e("th",null,"ID",-1),O={class:"actions two"},R={class:"form-check"},T=["disabled","onChange","checked"],U={class:"actions two"},X=["onClick"],Y=["onClick"],ae=I({__name:"WireGuardView",setup(Z){const b=y(),d=D([]),{t:c}=F();function w(n){N(b,`/wireguard/${n}`)}M({handle:(n,s)=>{s?B(c(s),"error"):d.value=n.wireGuards.map(i=>({...i,...j(i.config)}))},document:o`
    query {
      wireGuards {
        ...WireGuardFragment
      }
