import{_ as w}from"./FieldId-a909509e.js";import{_ as b}from"./Breadcrumb-cc2ecefa.js";import{d as V,u as y,r as A,i as C,t as F,Z as i,bV as u,o as r,c as d,b as e,e as m,f as a,F as I,y as N,w as p,g as l,P as _,Q as f,Y as h,V as q}from"./index-5f2856f5.js";import{_ as B}from"./DeleteConfirm.vuevuetypescriptsetuptruelang-3041997c.js";import{_ as M}from"./EditValueModal.vuevuetypescriptsetuptruelang-356103a8.js";import"./VModal.vuevuetypescriptsetuptruelang-1b277c9f.js";import"./vee-validate.esm-b3cf4904.js";const Q={class:"page-container container"},S={class:"main"},T={class:"table"},E=e("th",null,"ID",-1),L={class:"actions one"},O=["onClick"],P=["title"],U=["title"],Y={class:"actions one"},Z=["onClick"],X=V({__name:"DevicesView",setup(j){const{t:s}=y(),c=A([]);C({handle:(n,o)=>{o?F(s(o),"error"):c.value=[...n.devices]},document:i`
    query {
      devices {
        ...DeviceFragment
      }
