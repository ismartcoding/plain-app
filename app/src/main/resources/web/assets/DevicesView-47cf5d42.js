import{d as y,u as A,r as C,h as F,x as N,ac as r,c2 as p,S as I,c as o,a as e,p as m,t,F as M,J as q,o as i,w as _,m as v,k as d,Z as h,j as $,$ as f,a3 as D,ad as B,i as E,a6 as S}from"./index-e900249a.js";import{_ as T}from"./Breadcrumb-d9676db0.js";import{E as j}from"./EditValueModal-3013e2fe.js";import"./vee-validate.esm-d9208cf0.js";const J={class:"page-container"},L={class:"main"},O={class:"table-responsive"},Q={class:"table"},U=e("th",null,"ID",-1),Z={class:"actions one"},z=["onClick"],G={class:"nowrap"},H={class:"nowrap"},K={class:"actions one"},P=["onClick"],ee=y({__name:"DevicesView",setup(R){const{t:s}=A(),c=C([]);F({handle:(n,l)=>{l?N(s(l),"error"):c.value=[...n.devices]},document:r`
    query {
      devices {
        ...DeviceFragment
      }
